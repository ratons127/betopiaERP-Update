...
!define UNINSTALL_REGISTRY_KEY_SERVER "${UNINSTALL_BASE_REGISTRY_KEY}\BetopiaERP Server ${VERSION}"
...
!define MUI_FINISHPAGE_LINK_LOCATION "https://www.BetopiaERP.com/page/contactus"
...
; English
LangString DESC_BetopiaERP_Server ${LANG_ENGLISH} "Install the BetopiaERP Server with all the BetopiaERP standard modules."
LangString DESC_PostgreSQL ${LANG_ENGLISH} "Install the PostgreSQL RDBMS used by BetopiaERP."
LangString DESC_FinishPage_Link ${LANG_ENGLISH} "Contact BetopiaERP for Partnership and/or Support"
LangString DESC_AtLeastOneComponent ${LANG_ENGLISH} "You have to choose at least one component"
LangString DESC_CanNotInstallPostgreSQL ${LANG_ENGLISH} "You can not install the PostgreSQL database without the BetopiaERP Server"
...
LangString Profile_AllInOne ${LANG_ENGLISH} "BetopiaERP Server And PostgreSQL Server"
LangString Profile_Server ${LANG_ENGLISH} "BetopiaERP Server Only"
LangString TITLE_BetopiaERP_Server ${LANG_ENGLISH} "BetopiaERP Server"
LangString TITLE_PostgreSQL ${LANG_ENGLISH} "PostgreSQL Database"
LangString DESC_FinishPageText ${LANG_ENGLISH} "Start BetopiaERP"
...
Section $(TITLE_BetopiaERP_Server) SectionBetopiaERP_Server
    SectionIn 1 2
...
Section $(TITLE_PostgreSQL) SectionPostgreSQL
    ...
    ExecWait '"$TEMP\$postgresql_exe_filename" \
        ...
        --servicename "PostgreSQL_For_BetopiaERP" \
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
    !insertmacro MUI_DESCRIPTION_TEXT ${SectionBetopiaERP_Server} $(DESC_BetopiaERP_Server)
...
Function .onInit
    ...
    ${If} $previous_install_dir == ""
        StrCpy $INSTDIR "$PROGRAMFILES64\BetopiaERP ${VERSION}"
...
Function ComponentLeave
    SectionGetFlags ${SectionBetopiaERP_Server} $0
...
Function RestartBetopiaERPService
    DetailPrint "Restarting BetopiaERP Service"
