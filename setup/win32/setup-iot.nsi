...
; English
LangString DESC_BetopiaERP_IoT ${LANG_ENGLISH} "Install the BetopiaERP Server with IoT modules."
LangString DESC_FinishPage_Link ${LANG_ENGLISH} "Contact BetopiaERP for Partnership and/or Support"
LangString TITLE_BetopiaERP_IoT ${LANG_ENGLISH} "BetopiaERP IoT"
...
; French
LangString DESC_BetopiaERP_IoT ${LANG_FRENCH} "Installation du Serveur BetopiaERP avec les modules IoT."
...
Section $(TITLE_BetopiaERP_IoT) SectionBetopiaERP_IoT
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
    !insertmacro MUI_DESCRIPTION_TEXT ${SectionBetopiaERP_IoT} $(DESC_BetopiaERP_IoT)
...
Function .onInit
    ...
    ${If} $previous_install_dir == ""
        StrCpy $INSTDIR "$PROGRAMFILES64\BetopiaERP IoT ${VERSION}"
