...
[Contact Info](https://www.BetopiaERP.com/security-report)
...
Our [Responsible Disclosure](https://www.BetopiaERP.com/security-report) page gives an overview of the
process, including:
...
We receive a majority of security reports that have little to no impact on the security of BetopiaERP or
the BetopiaERP Cloud, and we ultimately have to reject them. To avoid a disappointing experience when
...
Also be sure to review our list of [non-qualifying issues](https://www.BetopiaERP.com/security-report#what).
