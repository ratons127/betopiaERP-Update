...
# The hard-coded super-user id (a.k.a. root user, or BetopiaERPBot).
SUPERUSER_ID = 1
...
def check_method_name(name):
    ...
    warnings.warn("Since 19.0, use betopiaerp.service.model.get_public_method", DeprecationWarning)
