...
from betopiaerp.tools import float_compare, float_is_zero, float_repr, float_round
from betopiaerp.tools.misc import SENTINEL, Sentinel
...
class Float(Field[float]):
    ...
    :param digits: a pair (total, decimal) or a string referencing a
        :class:`~betopiaerp.addons.base.models.decimal_precision.DecimalPrecision` record name.
    ...
    :func:`~betopiaerp.fields.Float.round()` to round a float with the given precision.
    :func:`~betopiaerp.fields.Float.is_zero()` to check if a float equals zero at the given precision.
    :func:`~betopiaerp.fields.Float.compare()` to compare two floats at the given precision.
...
class Monetary(Field[float]):
    ...
    :class:`res_currency<betopiaerp.addons.base.models.res_currency.Currency>`.
    ...
    :param str currency_field: name of the :class:`Many2one` field
        holding the :class:`res_currency <betopiaerp.addons.base.models.res_currency.Currency>`
