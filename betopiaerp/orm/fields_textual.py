...
from betopiaerp.netsvc import COLOR_PATTERN, DEFAULT, GREEN, RED, ColoredFormatter
from betopiaerp.tools import SQL, html_normalize, html_sanitize, html2plaintext, is_html_empty, plaintext2html, sql
from betopiaerp.tools.misc import OrderedSet, SENTINEL, Sentinel
from betopiaerp.tools.sql import pattern_to_translated_trigram_pattern, pg_varchar, value_to_translated_trigram_pattern
from betopiaerp.tools.translate import html_translate
...
if typing.TYPE_CHECKING:
    ...
    from betopiaerp.tools import Query
...
class Html(BaseString):
    ...
    def _get_attrs(self, model_class, name):
        ...
        # we do not need this Microsoft Outlook client feature for emails displayed BetopiaERP's web client.
