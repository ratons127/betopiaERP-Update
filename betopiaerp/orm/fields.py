...
from betopiaerp.tools import Query, SQL, reset_cached_properties, sql
from betopiaerp.tools.constants import PREFETCH_MAX
from betopiaerp.tools.misc import SENTINEL, ReadonlyDict, Sentinel, unique
...
_logger = logging.getLogger('betopiaerp.fields')
...
class Field(typing.Generic[T]):
    ...
    def _get_attrs(self, model_class: type[BaseModel], name: str) -> dict[str, typing.Any]:
        ...
        if 'group_operator' in attrs:
            warnings.warn("Since BetopiaERP 18, 'group_operator' is deprecated, use 'aggregator' instead", DeprecationWarning, stacklevel=2)
