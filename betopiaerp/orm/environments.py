...
"""The BetopiaERP API module defines BetopiaERP Environments.
"""
...
from betopiaerp.exceptions import AccessError, UserError, CacheMiss
from betopiaerp.sql_db import BaseCursor
from betopiaerp.tools import clean_context, frozendict, reset_cached_properties, OrderedSet, Query, SQL
from betopiaerp.tools.translate import get_translation, get_translated_module, LazyGettext
from betopiaerp.tools.misc import StackMap, SENTINEL
...
_logger = logging.getLogger('betopiaerp.api')
...
class Environment(Mapping[str, "BaseModel"]):
    ...
    def __call__(
        ...
        :type cursor: :class:`~betopiaerp.sql_db.Cursor`
    ...
    def user(self) -> BaseModel:
        ...
        :rtype: :class:`res.users record<~betopiaerp.addons.base.models.res_users.ResUsers>`"""
    ...
    def company(self) -> BaseModel:
        ...
        :rtype: :class:`res.company record<~betopiaerp.addons.base.models.res_company.Company>`
    ...
    def companies(self) -> BaseModel:
        ...
        :rtype: :class:`res.company recordset<~betopiaerp.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry: Registry):
        ...
        # temporary directories (managed in betopiaerp.tools.file_open_temporary_directory)
