...
"""The BetopiaERP API module defines method decorators.
"""
...
def constrains(*args) -> Decorator:
    ...
    Should raise :exc:`~betopiaerp.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall: bool) -> Decorator:
    """
    Mark a method to be executed during :meth:`~betopiaerp.models.BaseModel.unlink`.
...
def autovacuum(method: C) -> C:
    ...
    as in :meth:`~betopiaerp.addons.base.models.ir_cron.IrCron._commit_progress`.
    """
