...
from betopiaerp.exceptions import AccessError, UserError, MissingError
from betopiaerp.tools import SQL, OrderedSet, is_list_of, html_sanitize
from betopiaerp.tools.misc import frozendict, has_list_types
...
class Properties(Field):
    ...
    like BetopiaERP fields but without being independently stored in database.
    ...
    current record. The container must have a :class:`~betopiaerp.fields.PropertiesDefinition`
...
class PropertiesDefinition(Field):
    """ Field used to define the properties definition (see :class:`~betopiaerp.fields.Properties`
