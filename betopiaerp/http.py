...
r"""\
BetopiaERP HTTP layer / WSGI application
...
:class:`~betopiaerp.http.Controller`: class and its companion the
:func:`~betopiaerp.http.route`: method decorator. Together they are used to
...
Application.__call__
  ...
  request and itself in an BetopiaERP http request. The BetopiaERP http request is
...
import betopiaerp.init  # import first for core setup
...
<!-- Alternatively, use the X-BetopiaERP-Database header. -->
"""
...
def db_list(force=False, host=None):
    ...
    :param bool force: See :func:`~betopiaerp.service.db.list_dbs`:
    ...
    """
    try:
        dbs = betopiaerp.service.db.list_dbs(force)
...
def db_filter(dbs, host=None):
    ...
    if config['db_name']:
        # In case --db-filter is not provided and --database is passed, BetopiaERP will
...
def dispatch_rpc(service_name, method, params):
    ...
    """
    rpc_dispatchers = {
        'common': betopiaerp.service.common.dispatch,
        'db': betopiaerp.service.db.dispatch,
        'object': betopiaerp.service.model.dispatch,
    }
...
class Stream:
    ...
    def from_path(cls, path, filter_ext=('',), public=False):
        ...
        :param path: See :func:`~betopiaerp.tools.file_path`
        :param filter_ext: See :func:`~betopiaerp.tools.file_path`
    ...
    def get_response(
        ...
        **send_file_kwargs
        ...
        :param send_file_kwargs: Other keyword arguments to send to
            :func:`betopiaerp.tools._vendor.send_file.send_file` instead of
...
class Controller:
    ...
    :class:`~betopiaerp.http.Controller` can use the :func:`~betopiaerp.http.route`:
    ...
    :func:`~betopiaerp.http.route`:. Please note that the decorators of all
    ...
    .. code-block:
        ...
        class GreetingController(betopiaerp.http.Controller):
...
def route(route=None, **routing):
    ...
    .. warning::
        ...
        :class:`~betopiaerp.http.Controller` for more details.
...
class GeoIP(collections.abc.Mapping):
    ...
    .. note:
        ...
        :attr:`~betopiaerp.http.request.geoip`.
...
class _Response(werkzeug.wrappers.Response):
    ...
    def load(cls, result, fname="<function>"):
        ...
        :returns: The created :class:`~betopiaerp.http.Response`.
        :rtype: Response
...
class Response(Proxy):
    ...
    # betopiaerp.http._response attributes
    load = ProxyFunc()
...
class Request:
    ...
    def _get_session_and_dbname(self):
        ...
        header_dbname = self.httprequest.headers.get('X-BetopiaERP-Database')
    ...
    def update_env(self, user=None, context=None, su=None):
        ...
        :type user: int or :class:`res.users record<~betopiaerp.addons.base.models.res_users.ResUsers>`
    ...
    def make_response(self, data, headers=None, cookies=None, status=200):
        ...
        :rtype: :class:`~betopiaerp.http.Response`
        """
    ...
    def _serve_db(self):
        ...
        try:
            ...
            self.env = betopiaerp.api.Environment(cr, self.session.uid, self.session.context)
            try:
...
class HttpDispatcher(Dispatcher):
    ...
    def dispatch(self, endpoint, args):
        ...
        See :meth:`~betopiaerp.http.Response.load` method for the compatible
...
class JsonRPCDispatcher(Dispatcher):
    ...
    def handle_error(self, exc: Exception) -> collections.abc.Callable:
        ...
        if isinstance(exc, NotFound):
            ...
            error['code'] = 100
            error['message'] = "BetopiaERP Session Expired"
...
class Application:
    ...
    def initialize(self):
        ...
        from betopiaerp.service.server import load_server_wide_modules  # noqa: PLC0415
    ...
    def session_store(self):
        path = betopiaerp.tools.config.session_dir
    ...
    def __call__(self, environ, start_response):
        ...
        if betopiaerp.tools.config['proxy_mode'] and environ.get("HTTP_X_FORWARDED_HOST"):
