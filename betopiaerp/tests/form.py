# -*- coding: utf-8 -*-
"""
The module :mod:`betopiaerp.tests.form` provides an implementation of a client form
...
from betopiaerp import api, fields
...
class Form:
    ...
    * properly handle defaults & onchanges around x2many fields.
    ...
    of :class:`~betopiaerp.fields.Many2one` fields, one can assign a recordset::
    ...
    For :class:`~betopiaerp.fields.Many2many` fields, the field itself is a
    :class:`~betopiaerp.tests.common.M2MProxy` and can be altered by adding or
    removing records::
    ...
    Finally :class:`~betopiaerp.fields.One2many` are reified as :class:`~O2MProxy`.

    Because the :class:`~betopiaerp.fields.One2many` only exists through its parent,
...
class O2MProxy(X2MProxy):
    ...
    def new(self):
        ...
        :class:`~betopiaerp.fields.One2many` record, properly initialised.
    ...
    def edit(self, index):
        ...
        :class:`~betopiaerp.fields.One2many` record.
