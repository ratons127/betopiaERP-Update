...
BetopiaERP will use the SQL function 'unaccent' when available for the
...
import betopiaerp.orm.domains as orm_domains
import betopiaerp.modules
from betopiaerp.tools import Query, SQL
...
def normalize_domain(domain):
    ...
    """
    warnings.warn("Since 19.0, use betopiaerp.fields.Domain", DeprecationWarning)
...
def get_unaccent_wrapper(cr):
    ...
    return betopiaerp.modules.registry.Registry(cr.dbname).unaccent
