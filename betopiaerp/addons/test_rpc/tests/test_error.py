...
class TestError(common.HttpCase):
    ...
    def test_01_private(self):
        with self.assertRaisesRegex(Exception, r"Private method"), mute_logger('betopiaerp.http'):
    ...
    def test_01_create(self):
        ...
        with self.assertRaises(Fault) as ctx, mute_logger("betopiaerp.sql_db", "betopiaerp.http"):
    ...
    def test_03_sql_constraint(self):
        with mute_logger("betopiaerp.sql_db"), self.assertLogs("betopiaerp.http", level="WARNING") as capture:
