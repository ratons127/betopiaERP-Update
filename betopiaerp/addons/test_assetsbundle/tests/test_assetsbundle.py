...
from betopiaerp.addons.base.models.assetsbundle import AssetsBundle, XMLAssetError, ANY_UNIQUE
from betopiaerp.addons.base.models.ir_asset import AssetPaths
from betopiaerp.addons.base.models.ir_attachment import IrAttachment
...
class AddonManifestPatched(TransactionCase):
    def setUp(self):
        ...
        self.manifests = Manifests(betopiaerp.modules.Manifest.for_addon)

        self.patch(self.env.registry, '_init_modules', self.installed_modules)
        self.patch(betopiaerp.modules.Manifest, 'for_addon', lambda module, **kw: self.manifests[module])
...
class TestAssetsManifest(AddonManifestPatched):
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_asset')
    def test_31(self):
