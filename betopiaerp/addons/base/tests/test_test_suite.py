...
from betopiaerp.tests.case import TestCase
from betopiaerp.tests.common import BaseCase, TransactionCase, users, warmup, RegistryRLock
...
class TestTestSuite(TestCase):
    ...
    def test_test_suite(self):
        """ Check that BetopiaERPSuite handles unittest.TestCase correctly. """
...
class TestRunnerLoggingCommon(TransactionCase):
    ...
    def _addError(self, result, test, exc_info):
        ...
        try:
            ...
            fake_result = BetopiaERPTestResult()
    ...
    def _check_log_records(self, log_records):
        ...
        for log_record in log_records:
            ...
            self._assert_log_equal(log_record, 'name', 'betopiaerp.addons.base.tests.test_test_suite')
