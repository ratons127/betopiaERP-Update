...
from betopiaerp.tests.common import standalone
from betopiaerp.tests.test_module_operations import install
from betopiaerp.tools import mute_logger
from betopiaerp.tools.convert import ParseError
...
def test_isolated_install(env):
    ...
    try:
        with mute_logger('betopiaerp.modules.registry'):
