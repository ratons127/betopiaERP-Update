...
from betopiaerp.tests.common import BaseCase, TransactionCase, tagged, new_test_user, HttpCase
from betopiaerp.tools import profiler
from betopiaerp.tools.profiler import Profiler, ExecutionContext
from betopiaerp.tools.speedscope import Speedscope
...
class TestProfiling(TransactionCase):
    ...
    def test_profiler_return(self):
        ...
        self.startClassPatcher(patch('betopiaerp.sql_db.db_connect', return_value=self.registry))
