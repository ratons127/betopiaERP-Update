...
from betopiaerp.tools.pdf.signature import PdfSigner
...
class TestSignature(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cert_subject = x509.Name([
            ...
            x509.NameAttribute(NameOID.ORGANIZATION_NAME, "BetopiaERP"),
            x509.NameAttribute(NameOID.COMMON_NAME, "betopiaerp.com")
        ])
