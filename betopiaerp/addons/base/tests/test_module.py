...
from betopiaerp.modules.module import Manifest
...
class TestModuleManifest(BaseCase):
    ...
    def setUpClass(cls):
        ...
        patcher = patch.object(betopiaerp.addons, '__path__', [cls.addons_path])
    ...
    def test_default_manifest(self):
        ...
        with self.assertNoLogs('betopiaerp.modules.module', 'WARNING'):
    ...
    def test_missing_manifest(self):
        with self.assertLogs('betopiaerp.modules.module', 'DEBUG') as capture:
    ...
    def test_missing_license(self):
        ...
        with self.assertLogs('betopiaerp.modules.module', 'WARNING') as capture:
            manifest = Manifest.for_addon(self.module_name)
