...
from betopiaerp.tests.common import BaseCase, HttpCase
from betopiaerp.tests.test_cursor import TestCursor
from betopiaerp.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('betopiaerp.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:betopiaerp.sql_db:Found different un-closed cursor', msg)
