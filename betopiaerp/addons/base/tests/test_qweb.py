...
from betopiaerp.addons.base.models.ir_qweb import QWebError
from betopiaerp.tools import file_open, misc, mute_logger
from betopiaerp.tools.json import scriptsafe as json_scriptsafe
from betopiaerp.exceptions import UserError, MissingError
...
class TestQWebNS(TransactionCase):
    ...
    def test_render_dynamic_xml_with_code_error(self):
        ...
        view1 = self.env['ir.ui.view'].create({
            ...
            'arch': """
                <t t-name="base.dummy">
                    <Invoice xmlns:od="http://betopiaerp.com/od">
...
class TestQWebBasic(TransactionCase):
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_qweb')
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_qweb') # warning for template not found
