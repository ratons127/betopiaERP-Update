...
from betopiaerp.http import _request_stack
from betopiaerp.tests import Form, TransactionCase, new_test_user, tagged, HttpCase, users, warmup
...
class TestUsers(UsersCommonCase):
    ...
    @mute_logger('betopiaerp.sql_db', 'betopiaerp.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('betopiaerp.addons.base.models.res_users.request', request)
...
class TestUsers2(UsersCommonCase):
    ...
    def test_view_group_hierarchy(self):
        ...
        with patch('betopiaerp.addons.base.models.res_groups.ResGroups._get_view_group_hierarchy') as mock:
