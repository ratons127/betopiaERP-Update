...
from betopiaerp import Command, models
from betopiaerp.addons.base.models.ir_mail_server import extract_rfc2822_addresses
from betopiaerp.addons.base.models.res_partner import ResPartner
from betopiaerp.addons.base.tests.common import TransactionCaseWithUserDemo
from betopiaerp.exceptions import AccessError, RedirectWarning, UserError, ValidationError
from betopiaerp.tests import Form
from betopiaerp.tests.common import new_test_user, tagged, TransactionCase, users
...
class TestPartner(TransactionCaseWithUserDemo):
    ...
    def test_main_user_id(self):
        """Test main_user_id compute, including BetopiaERPBot special case and priority among several users."""
