...
import betopiaerp
from betopiaerp.exceptions import UserError, ValidationError, AccessError
from betopiaerp.tools import mute_logger
from betopiaerp.tests import common, tagged
from betopiaerp.addons.base.tests.common import TransactionCaseWithUserDemo
...
class TestServerActions(TestServerActionsBase):
    def test_00_server_action(self):
        with self.assertLogs('betopiaerp.addons.base.models.ir_actions.server_action_safe_eval',
                             level='DEBUG') as log_catcher:
            self.test_server_action.run()
            self.assertEqual(log_catcher.output, [
                'DEBUG:betopiaerp.addons.base.models.ir_actions.server_action_safe_eval:This is a test debug log',
                'INFO:betopiaerp.addons.base.models.ir_actions.server_action_safe_eval:This is a test info log',
                'WARNING:betopiaerp.addons.base.models.ir_actions.server_action_safe_eval:This is a test warning log',
                'ERROR:betopiaerp.addons.base.models.ir_actions.server_action_safe_eval:This is a test error log',
"""ERROR:betopiaerp.addons.base.models.ir_actions.server_action_safe_eval:This is a test exception log
...
ZeroDivisionError: division by zero""" % self.test_server_action.id
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_model', 'betopiaerp.models')
    ...
    def test_90_webhook(self):
        ...
        with patch.object(requests, 'post', _patched_post), mute_logger('betopiaerp.addons.base.models.ir_actions'):
            # first run: 200
            self.action.with_context(self.context).run()
...
class TestCustomFields(TestCommonCustomFields):
    def test_create_custom(self):
        ...
        with self.assertRaises(IntegrityError), mute_logger('betopiaerp.sql_db'):
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_ui_view')
...
class TestCustomFieldsPostInstall(TestCommonCustomFields):
    def test_add_field_valid(self):
        ...
        with self.assertLogs('betopiaerp.registry') as log_catcher:
