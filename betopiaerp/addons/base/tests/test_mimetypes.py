...
from betopiaerp.tools.mimetypes import fix_filename_extension, get_extension, guess_mimetype
...
class test_guess_mimetype(BaseCase):
    ...
    def test_mimetype_fix_extension(self):
        ...
        with self.assertLogs('betopiaerp.tools.mimetypes', 'WARNING') as capture:
            self.assertEqual(fix('image.txt', 'image/jpeg'), 'image.txt.jpg')
            self.assertEqual(fix('words.jpg', 'text/plain'), 'words.jpg.txt')
        self.assertEqual(capture.output, [
            "WARNING:betopiaerp.tools.mimetypes:File 'image.txt' has an invalid "
                "extension for mimetype 'image/jpeg', adding '.jpg'",
            "WARNING:betopiaerp.tools.mimetypes:File 'words.jpg' has an invalid "
