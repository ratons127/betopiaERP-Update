...
from betopiaerp.addons.base.tests import mail_examples
...
class TestIrMailServer(TransactionCase, MockSmtplibCase):
    ...
    def test_mail_server_priorities(self):
        ...
        simple BetopiaERP DB so we have to spoof the FROM otherwise we cannot send
        any email. """
    ...
    @mute_logger('betopiaerp.models.unlink', 'betopiaerp.addons.base.models.ir_mail_server')
    ...
    def test_mail_server_config_bin(self):
        ...
        # for from_filter in ICP, overwrite the one from betopiaerp-bin
