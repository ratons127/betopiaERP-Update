...
@betopiaerp.tests.tagged('post_install', '-at_install', 'post_install_l10n')
class TestReports(betopiaerp.tests.TransactionCase):
...
class TestReportsRenderingCommon(betopiaerp.tests.HttpCase):
    ...
    def save_pdf(self):
        ...
        betopiaerp.tests.save_test_file(self._testMethodName, self.last_pdf_content, 'pdf_', 'pdf', document_type='Report PDF', logger=_logger)
...
@betopiaerp.tests.tagged('post_install', '-at_install', 'pdf_rendering')
...
@betopiaerp.tests.tagged('post_install', '-at_install', '-standard', 'pdf_rendering')
...
class TestAggregatePdfReports(betopiaerp.tests.HttpCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
