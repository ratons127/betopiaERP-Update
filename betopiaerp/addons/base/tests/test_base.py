...
from betopiaerp.tests.common import TransactionCase, BaseCase
from betopiaerp.tools import mute_logger
from betopiaerp.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('betopiaerp.tools.safe_eval')
    def test_05_safe_eval_forbiddon(self):
        ...
        with self.assertRaises(ValueError):
            safe_eval("import betopiaerp", mode="exec")
