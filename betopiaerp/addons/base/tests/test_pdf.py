...
from betopiaerp.tools import pdf
from betopiaerp.tools.misc import file_open
from betopiaerp.tools.pdf import reshape_text
import io
...
class TestPdf(TransactionCase):
    ...
    def test_betopiaerp_pdf_file_reader_with_owner_encryption(self):
        ...
        with io.BytesIO(encrypted_content) as reader_buffer:
            pdf_reader = pdf.BetopiaERPPdfFileReader(reader_buffer)
    ...
    def test_merge_pdf(self):
        ...
        merged_pdf_reader = pdf.BetopiaERPPdfFileReader(merged_reader_buffer)
    ...
    def test_branded_file_writer(self):
        ...
        self.assertEqual(pdf_info['/Producer'], 'BetopiaERP')
        self.assertEqual(pdf_info['/Creator'], 'BetopiaERP')
        reader_buffer.close()
