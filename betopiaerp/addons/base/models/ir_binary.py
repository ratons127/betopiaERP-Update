...
from betopiaerp.exceptions import MissingError, UserError
from betopiaerp.http import Stream, request
from betopiaerp.tools import file_open, replace_exceptions
from betopiaerp.tools.image import image_guess_size_from_field_name, image_process
from betopiaerp.tools.mimetypes import MIMETYPE_HEAD_SIZE, get_extension, guess_mimetype
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:betopiaerp.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~betopiaerp.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`betopiaerp.tools.image.image_process`.
