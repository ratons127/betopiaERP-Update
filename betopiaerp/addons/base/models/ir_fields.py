...
from betopiaerp import api, Command, fields, models
from betopiaerp.tools import OrderedSet
from betopiaerp.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str, *, savepoint):
        ...
        :param model: :class:`betopiaerp.models.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str, *, savepoint):
        ...
        :type field: :class:`betopiaerp.fields.Field`
