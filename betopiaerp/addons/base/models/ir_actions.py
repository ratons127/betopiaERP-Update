...
from betopiaerp.tools import _, frozendict, get_lang
from betopiaerp.tools.float_utils import float_compare
from betopiaerp.tools.misc import get_diff, unquote
from betopiaerp.tools.safe_eval import safe_eval, test_python_expr
...
class IrActionsServer(models.Model):
    ...
    Since BetopiaERP 8.0 a button 'Create Menu Action' button is available on the
