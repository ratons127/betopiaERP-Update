...
from betopiaerp.tools import OrderedSet, misc, profiler
from betopiaerp.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS
from betopiaerp.tools.json import scriptsafe as json
from betopiaerp.tools.misc import file_open, file_path
...
class AssetsBundle(object):
            ...
            if self.templates:
                ...
                template_bundle = textwrap.dedent(f"""
                    ...
                    *******************************************/
                    ...
                    betopiaerp.define("{self.name}.bundle.xml", ["@web/core/templates"], function(require) {{
                        "use strict";
    ...
    def js_with_sourcemap(self, template_bundle=None):
        ...
        """
        from betopiaerp.tools.sourcemap_generator import SourceMapGenerator  # noqa: PLC0415
    ...
    def compile_css(self, compiler, source):
        ...
        def sanitize(matchobj):
            ...
            if '.' not in ref and line not in imports and not ref.startswith(('.', '/', '~')):
                imports.append(line)
                return line
            msg = "Local import '%s' is forbidden for security reasons. Please remove all @import {your_file} imports in your custom files. In BetopiaERP you have to import all files in the assets, and not through the @import statement." % ref
            _logger.warning(msg)
    ...
    def content(self):
        ...
        if self.is_transpiled:
            if not self._converted_content:
                from betopiaerp.tools.js_transpiler import transpile_javascript  # noqa: PLC0415
