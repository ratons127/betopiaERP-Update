...
import betopiaerp
from betopiaerp import api, http, models, tools
from betopiaerp.api import SUPERUSER_ID
from betopiaerp.exceptions import AccessDenied
from betopiaerp.http import ROUTING_KEYS, SAFE_HTTP_METHODS, Response, request
from betopiaerp.modules.registry import Registry
from betopiaerp.service import security
from betopiaerp.tools.json import json_default
from betopiaerp.tools.misc import get_lang, submap
from betopiaerp.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and betopiaerp.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (betopiaerp.exceptions.AccessError, betopiaerp.exceptions.MissingError) as e:
                ...
                if request.env.user.is_public or isinstance(e, betopiaerp.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(betopiaerp.tools.config['server_wide_modules'])
