...
from betopiaerp.modules.registry import _REGISTRY_CACHES
from betopiaerp.tools import config, safe_eval, OrderedSet, frozendict, json
from betopiaerp.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from betopiaerp.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from betopiaerp.tools.lru import LRU
from betopiaerp.tools.misc import str2bool, file_open, file_path
from betopiaerp.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from betopiaerp.tools.profiler import ExecutionContext
from betopiaerp.tools.translate import FORMAT_REGEX
from betopiaerp.http import request
from betopiaerp.tools.profiler import QwebTracker
from betopiaerp.exceptions import UserError, MissingError

from betopiaerp.addons.base.models.assetsbundle import AssetsBundle
from betopiaerp.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since BetopiaERP 17.0, keep the value empty and configure the "
