...
class IrCron(models.Model):
    ...
    def _check_modules_state(cr, jobs):
        ...
        # reset_module_states.
        from betopiaerp.modules.loading import reset_modules_state  # noqa: PLC0415
