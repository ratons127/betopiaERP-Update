...
from betopiaerp.exceptions import AccessDenied, UserError, ValidationError
from betopiaerp.fields import Domain
from betopiaerp.tools import config
from betopiaerp.tools.parse_version import parse_version
from betopiaerp.tools.misc import topological_sort, get_flag
from betopiaerp.tools.translate import TranslationImporter, get_po_paths, get_datafile_translation_path
from betopiaerp.http import request
from betopiaerp.modules.module import Manifest, MissingDependency
...
class IrModuleModule(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'BetopiaERP Enterprise Edition License v1.0'),
        ('OPL-1', 'BetopiaERP Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('BetopiaERP Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        if self.search_count([('state', 'in', ('to install', 'to upgrade', 'to remove'))], limit=1):
            raise UserError(_("BetopiaERP is currently processing another module operation.\n"
        ...
        try:
            ...
            raise UserError(_("BetopiaERP is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(betopiaerp.tools.config['server_wide_modules']) & set(self.mapped('name'))
