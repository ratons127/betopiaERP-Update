...
from betopiaerp.tests import Form, TransactionCase, users
from betopiaerp.tools import get_lang, mute_logger
...
class PropertiesCase(TestPropertiesMixin):
    ...
    @mute_logger('betopiaerp.models.unlink', 'betopiaerp.fields')
    ...
    @users('test')
    @mute_logger('betopiaerp.addons.base.models.ir_rule', 'betopiaerp.fields')
    ...
    def test_properties_field_security(self):
        ...
        self.env.invalidate_all()
        with patch('betopiaerp.addons.test_orm.models.test_orm.TestOrmMultiTag.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        ...
        self.env.invalidate_all()
        with patch('betopiaerp.addons.test_orm.models.test_orm.TestOrmDiscussion.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        self.assertEqual(values['value'], (tag.id, 'Test Tag'))
...
class PropertiesGroupByCase(TestPropertiesMixin):
    ...
    @mute_logger('betopiaerp.fields', 'betopiaerp.models.unlink')
