...
from betopiaerp import Command, fields, models
from betopiaerp.exceptions import AccessError, MissingError, UserError, ValidationError
from betopiaerp.fields import Domain
from betopiaerp.tests import Form, TransactionCase, tagged, users
from betopiaerp.tools import float_repr, mute_logger
from betopiaerp.tools.image import image_data_uri

from betopiaerp.addons.base.tests.common import TransactionCaseWithUserDemo
from betopiaerp.addons.base.tests.test_expression import TransactionExpressionCase
...
%endif"""
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_model')
    ...
    def test_85_binary_guess_zip(self):
        from betopiaerp.addons.base.tests.test_mimetypes import ZIP  # noqa: PLC0415
    ...
    def test_86_text_base64_guess_svg(self):
        from betopiaerp.addons.base.tests.test_mimetypes import SVG  # noqa: PLC0415
...
class TestX2many(TransactionExpressionCase):
    ...
    def test_10_ondelete_many2many(self):
        ...
        with self.assertRaises(psycopg2.IntegrityError):
            with mute_logger('betopiaerp.sql_db'):
                record_a.unlink()
...
%endif"""
    ...
    @patch('betopiaerp.orm.fields_textual.html_sanitize', return_value='<p>comment</p>')
...
class TestSelectionOndeleteAdvanced(TransactionCase):
    ...
    def test_ondelete_unexisting_policy(self):
        from betopiaerp.orm.model_classes import add_to_registry  # noqa: PLC0415
...
class TestFieldParametersValidation(TransactionCase):
    def test_invalid_parameter(self):
        ...
        with self.assertLogs('betopiaerp.fields', level='WARNING') as cm:
            self.registry._setup_models__(self.env.cr, [])  # incremental setup

        self.assertTrue(cm.output[0].startswith(
            "WARNING:betopiaerp.fields:Field test_orm.field_parameter_validation.name: "
...
class TestUnlinkConstraints(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        from betopiaerp.addons.base.models.ir_model import (  # noqa: PLC0415
