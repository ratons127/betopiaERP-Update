...
def _check_with_xsd(tree_or_str, stream, env=None, prefix=None):
    ...
    :param betopiaerp.api.Environment env: If it is given, it enables resolving the
...
def load_xsd_files_from_url(env, url, file_name=None, force_reload=False,
    ...
    :param betopiaerp.api.Environment env: environment of calling module
    ...
    :rtype: betopiaerp.api.ir.attachment | bool
...
def validate_xml_from_attachment(env, xml_content, xsd_name, reload_files_function=None, prefix=None):
    ...
    :return: the result of the function :func:`betopiaerp.tools.xml_utils._check_with_xsd`
    """
