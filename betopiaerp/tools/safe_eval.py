...
_BUBBLEUP_EXCEPTIONS = (
    betopiaerp.exceptions.UserError,
    betopiaerp.exceptions.RedirectWarning,
...
`betopiaerp.tools.safe_eval.wrap_module` to generate a wrapper recursively
whitelisting allowed attributes.

Pre-wrapped modules are provided as attributes of `betopiaerp.tools.safe_eval`.
""")
    return d
...
from betopiaerp._monkeypatches.pytz import patch_module as patch_pytz  # noqa: E402, F401
patch_pytz()
