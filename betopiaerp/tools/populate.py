...
This tool provides utilities to duplicate records across models in BetopiaERP, while maintaining referential integrity,
...
from betopiaerp.fields import Field, Many2one
