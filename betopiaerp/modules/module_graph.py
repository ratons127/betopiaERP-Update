...
from betopiaerp.tools import reset_cached_properties, OrderedSet
...
class ModuleNode:
    """
    Loading and upgrade info for an BetopiaERP module
    """
...
class ModuleGraph:
    """
    Sorted BetopiaERP modules ordered by (module.phase, module.depth, module.name)
    """
