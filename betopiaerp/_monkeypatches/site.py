...
betopiaerp.evented = False


def patch_evented():
    """Running mode flags (gevent, prefork)

    This should be executed early. It will initialize the `betopiaerp.evented` variable.
    """
    if betopiaerp.evented or not (len(sys.argv) > 1 and sys.argv[1] == 'gevent'):
        return
