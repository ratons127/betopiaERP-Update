...
from betopiaerp.tools import DEFAULT_SERVER_DATETIME_FORMAT
from betopiaerp.addons.stock.tests.common import TestStockCommon
...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def test_incoming_with_negative_qty(self):
        ...
        # it is negative qty transfer so BetopiaERP will create delivery instead of receipt.
