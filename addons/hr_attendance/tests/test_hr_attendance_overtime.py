...
from betopiaerp.tests import Form, HttpCase, new_test_user
...
class TestHrAttendanceOvertime(HttpCase):
    ...
    def test_overtime_with_public_holidays(self):
        ...
        with freeze_time("2025-11-11 12:00:00"):
            ...
            company_be = self.env['res.company'].create({'name': 'BetopiaERP BE'})
            company_de = self.env['res.company'].create({'name': 'BetopiaERP DE'})
