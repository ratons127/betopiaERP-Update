...
from betopiaerp.addons.l10n_tw_edi_ecpay.tests.test_edi import L10nTWITestEdi
from betopiaerp.tests import tagged


CALL_API_METHOD = 'betopiaerp.addons.l10n_tw_edi_ecpay.utils.EcPayAPI.call_ecpay_api'
