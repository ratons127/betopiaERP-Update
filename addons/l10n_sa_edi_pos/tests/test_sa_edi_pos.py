...
from betopiaerp.addons.l10n_sa_edi.tests.common import AccountEdiTestCommon
from betopiaerp.addons.point_of_sale.tests.test_frontend import TestPointOfSaleHttpCommon
from betopiaerp.addons.point_of_sale.tests.test_generic_localization import (
...
class TestUi(TestPointOfSaleHttpCommon):
    ...
    @patch('betopiaerp.addons.l10n_sa_edi.models.account_journal.AccountJournal._l10n_sa_ready_to_submit_einvoices',
