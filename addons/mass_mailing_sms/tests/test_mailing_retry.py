...
from betopiaerp.addons.mass_mailing_sms.tests.common import MassSMSCommon
...
class TestMailingRetrySMS(MassSMSCommon, CronMixinCase):
    ...
    def test_sms_retry_immediate_trigger(self):
        ...
        with patch('betopiaerp.addons.sms.models.sms_sms.SmsSms._send', patched_sms_sms_send):
