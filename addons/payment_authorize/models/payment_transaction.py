...
from betopiaerp import _, models
...
from betopiaerp.addons.payment_authorize import const
from betopiaerp.addons.payment_authorize.models.authorize_request import AuthorizeAPI
...
class PaymentTransaction(models.Model):
    ...
    def _send_refund_request(self):
        ...
        if tx_status in const.TRANSACTION_STATUS_MAPPING['voided']:
            ...
            # create a refund tx on BetopiaERP to reflect the move of the funds.
            self._set_done()
