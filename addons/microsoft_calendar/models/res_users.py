...
import logging
import requests
from betopiaerp.addons.microsoft_calendar.models.microsoft_sync import microsoft_calendar_token
from datetime import datetime, timedelta

from betopiaerp import api, fields, models, _, Command
from betopiaerp.exceptions import UserError
from betopiaerp.loglevels import exception_to_unicode
from betopiaerp.addons.microsoft_account.models import microsoft_service
from betopiaerp.addons.microsoft_calendar.utils.microsoft_calendar import InvalidSyncToken
from betopiaerp.tools import str2bool
...
class ResUsers(models.Model):
    ...
    def _set_ICP_first_synchronization_date(self, now):
        ...
        created BetopiaERP events and thus avoid spamming invitations for those events.
        """
