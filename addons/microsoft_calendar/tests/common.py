...
class TestCommon(HttpCase):
    ...
    def setUp(self):
        ...
        # simple event values to create a BetopiaERP event
        ...
        # -----------------------------------------------------------------------------------------
        # Expected values for BetopiaERP events converted to Outlook events (to be posted through API)
        # -----------------------------------------------------------------------------------------
