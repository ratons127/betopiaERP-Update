...
from betopiaerp.addons.iap import jsonrpc

DEFAULT_IAP_ENDPOINT = "https://l10n-in-edi.api.betopiaerp.com"
DEFAULT_IAP_TEST_ENDPOINT = "https://l10n-in-edi-demo.api.betopiaerp.com"
