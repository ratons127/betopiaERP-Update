...
from betopiaerp.addons.account.tests.test_taxes_downpayment import TestTaxesDownPayment
from betopiaerp.addons.point_of_sale.tests.test_frontend import TestTaxCommonPOS
from betopiaerp.addons.sale.tests.common import TestTaxCommonSale
