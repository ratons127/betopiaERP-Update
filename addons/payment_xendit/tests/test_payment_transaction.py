...
from betopiaerp.addons.payment_xendit.controllers.main import XenditController
from betopiaerp.addons.payment_xendit.tests.common import XenditCommon
...
class TestPaymentTransaction(PaymentHttpCommon, XenditCommon):
    ...
    def test_no_input_missing_from_redirect_form(self):
        ...
        tx = self._create_transaction('redirect')
        with patch(
            'betopiaerp.addons.payment_xendit.models.payment_transaction.PaymentTransaction'
    ...
    @mute_logger('betopiaerp.addons.payment_xendit.controllers.main')
