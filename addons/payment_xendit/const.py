...
# When user chooses FPX in BetopiaERP, this list becomes filtered payment options in Xendit dashboard
# When webhook is received from Xendit, we can map all of these options back to 'fpx' in BetopiaERP
FPX_METHODS = [
    "DD_UOB_FPX",
    "DD_PUBLIC_FPX",
    "DD_AFFIN_FPX",
