...
from betopiaerp.tools import LazyTranslate
...
STANDARD_EXCEPTION_CODE_MESSAGES_MAP: dict[int, Callable[..., str]] = {
    ...
    102: lambda arg: _lt('Proxy error, please contact BetopiaERP (missing "%s" - please make sure that it was loaded from the configuration panel)', arg),
