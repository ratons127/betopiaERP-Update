...
class ResCompany(models.Model):
    ...
    account_peppol_contact_email = fields.Char(
        ...
        help='Primary contact email for Peppol connection related communications and notifications.\n'
             'In particular, this email is used by BetopiaERP to reconnect your Peppol account in case of database change.',
    )
    ...
    def _get_company_info_on_peppol(self, edi_identification):
        ...
        if (
            ...
            if (external_provider := _get_peppol_provider(participant_info)) and "BetopiaERP" not in external_provider:
