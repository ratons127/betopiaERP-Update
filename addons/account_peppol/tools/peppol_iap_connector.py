...
TIMEOUT = 10
PEPPOL_PROXY_URLS = {
    'prod': 'https://peppol.api.betopiaerp.com',
    'test': 'https://peppol.test.betopiaerp.com',
}
...
class PeppolIAPConnector:
    ...
    def request_public_http(self, method, endpoint, data=None, params=None):
        ...
        try:
            ...
            _logger.debug("Failed to connect to BetopiaERP Peppol Proxy %s, %s", endpoint, e)
            raise UserError(self.env._("Failed to connect to BetopiaERP Peppol Proxy."))
