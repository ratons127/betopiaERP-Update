...
from betopiaerp.tests.common import tagged, freeze_time
...
class TestPeppolMessage(TestAccountMoveSendCommon, MailCommon):
            ...
            if peppol_identifier == '0208:0477472701':
                ...
                response.json = lambda: {
                    "result": {
                        ...
                        'smp_base_url': "http://iap-services.betopiaerp.com",
                        'ttl': 60,
                        'service_group_url': f'http://iap-services.betopiaerp.com/iso6523-actorid-upis%3A%3A{url_quoted_peppol_identifier}',
                        'services': [
                            {
                                "href": f"http://iap-services.betopiaerp.com/iso6523-actorid-upis%3A%3A{url_quoted_peppol_identifier}/services/busdox-docid-qns%3A%3Aurn%3Aoasis%3Anames%3Aspecification%3Aubl%3Aschema%3Axsd%3AInvoice-2%3A%3AInvoice%23%23urn%3Acen.eu%3Aen16931%3A2017%23compliant%23urn%3Afdc%3Apeppol.eu%3A2017%3Apoacc%3Abilling%3A3.0%3A%3A2.1",
    ...
    @patch('betopiaerp.addons.account_peppol.models.res_partner.ResPartner._check_document_type_support', return_value=False)
    ...
    def test_silent_error_while_creating_xml(self):
        ...
        wizard = self.create_send_and_print(move_1 + move_2)
        with patch(
            'betopiaerp.addons.account_edi_ubl_cii.models.account_edi_xml_ubl_20.AccountEdiXmlUBL20._export_invoice_constraints',
