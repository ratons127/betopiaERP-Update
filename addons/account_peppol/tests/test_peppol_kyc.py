...
from betopiaerp.tests.common import HttpCase, tagged, freeze_time
from betopiaerp.tools import mute_logger

from betopiaerp.addons.account_peppol.tests.common import PeppolConnectorCommon
from betopiaerp.addons.account_peppol.tools.peppol_iap_connector import PeppolIAPConnector
...
class TestPeppolKYC(PeppolConnectorCommon, HttpCase):
    ...
    def _mock_can_connect_method(self, with_auth=False):
        ...
        return patch('betopiaerp.addons.account_peppol.tools.peppol_iap_connector.PeppolIAPConnector.can_connect', return_value={
            'auth_required': with_auth,
            **auth_vals,
        })

    def _mock_create_connection_method(self, id_client='test_id_client', peppol_state='smp_registration'):
        return patch('betopiaerp.addons.account_peppol.tools.peppol_iap_connector.PeppolIAPConnector.create_connection', return_value={
    ...
    @mute_logger('betopiaerp.addons.account_peppol.controllers.authentication')
