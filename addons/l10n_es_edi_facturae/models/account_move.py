...
from betopiaerp.tools import float_round, float_repr, float_compare, date_utils, SQL
from betopiaerp.tools.xml_utils import cleanup_xml_node, find_xml_value
from betopiaerp.tools.sql import column_exists, create_column
from betopiaerp.addons.l10n_es_edi_facturae.xml_utils import (
    NS_MAP,
    _canonicalize_node,
    _reference_digests,
)
...
class AccountMove(models.Model):
    ...
    def _search_product_for_import(self, item_description):
        # Exported BetopiaERP XML will have item_description = "[default_code] name".
