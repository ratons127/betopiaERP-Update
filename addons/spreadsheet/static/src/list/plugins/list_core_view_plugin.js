...
import { BetopiaERPCoreViewPlugin } from "@spreadsheet/plugins";
...
export class ListCoreViewPlugin extends BetopiaERPCoreViewPlugin {
     ...
     */
    _refreshBetopiaERPLists() {
        for (const listId of this.getters.getListIds()) {
            this._refreshBetopiaERPList(listId);
        }
    }
