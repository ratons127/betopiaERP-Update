 ...
 */
export class BetopiaERPPivotModel extends PivotModel {
    /**
     * @param {import("@web/env").BetopiaERPEnv} env
     * @param {import("@spreadsheet").BetopiaERPPivotModelParams} params
    ...
    constructor(env, params, services) {
        ...
        /**
         * @type {import("@spreadsheet").BetopiaERPGetters}
         */
    ...
    /**
     * Get the BetopiaERP domain corresponding to the given domain
     * @param {PivotDomain} domain
     */
