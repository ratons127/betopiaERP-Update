 ...
 * @param {Record<string, BetopiaERPField | undefined>} allFields
 * @param {string} groupFieldString
 * @returns {{field: BetopiaERPField, granularity: Granularity, isPositional: boolean, dimensionWithGranularity: string}}
 */
