...
import { NO_RECORD_AT_THIS_POSITION, BetopiaERPPivotModel } from "./pivot_model";
import { EvaluationError, PivotRuntimeDefinition, registries, helpers } from "@betopiaerp/o-spreadsheet";
import { LOADING_ERROR } from "@spreadsheet/data_sources/data_source";
import { omit } from "@web/core/utils/objects";
import { BetopiaERPPivotLoader } from "./betopiaerp_pivot_loader";
...
/**
 * @typedef {import("@betopiaerp/o-spreadsheet").FunctionResultObject} FunctionResultObject
 ...
 * @typedef {import("@betopiaerp/o-spreadsheet").PivotDimension} PivotDimension
 * @typedef {import("@betopiaerp/o-spreadsheet").PivotCoreMeasure} PivotCoreMeasure
 * @typedef {import("@spreadsheet").WebPivotModelParams} WebPivotModelParams
 * @typedef {import("@spreadsheet").BetopiaERPPivot<BetopiaERPPivotRuntimeDefinition>} IPivot
 * @typedef {import("@spreadsheet").BetopiaERPFields} BetopiaERPFields
 * @typedef {import("@spreadsheet").BetopiaERPPivotCoreDefinition} BetopiaERPPivotCoreDefinition
 * @typedef {import("@spreadsheet").BetopiaERPGetters} BetopiaERPGetters
 ...
 * @implements {IPivot}
 */
export class BetopiaERPPivot {
    /**
     *
     * @override
     * @param {Object} services Services (see DataSource)
     * @param {Object} params
     * @param {BetopiaERPPivotCoreDefinition} params.definition
     * @param {BetopiaERPGetters} params.getters
     */
    constructor(services, { definition, getters }) {
        /** @type {"BETOPIAERP"} */
        this.type = "BETOPIAERP";

        /** @type {BetopiaERPPivotCoreDefinition} @protected */
        this.coreDefinition = definition;

        this.needsReevaluation = false;

        /** @type {BetopiaERPPivotRuntimeDefinition | undefined} @protected */
        this.runtimeDefinition = undefined;

        /** @type {BetopiaERPPivotModel | undefined} @protected */
        this.model = undefined;

        /** @type {BetopiaERPGetters} @protected */
        this.getters = getters;

        /** @protected */
        this.loader = new BetopiaERPPivotLoader(services.betopiaerpDataProvider, this._load.bind(this));

        /** @type {BetopiaERPFields | undefined} @protected */
        this._fields = undefined;

        /** @protected @type {BetopiaERPDataProvider}*/
        this.betopiaerpDataProvider = services.betopiaerpDataProvider;
    ...
    /**
     * @param {BetopiaERPPivotCoreDefinition} nextDefinition
     */
    onDefinitionChange(nextDefinition) {
        ...
        if (
            ...
            if (
                ...
                this.coreDefinition = nextDefinition;
                const runtimeDefinition = new BetopiaERPPivotRuntimeDefinition(
                    this.coreDefinition,
                    this.getFields()
                );
    ...
    async createModelAndDefinition() {
        ...
        const definition = new BetopiaERPPivotRuntimeDefinition(this.coreDefinition, this.getFields());
        const model = new BetopiaERPPivotModel(
            { _t },
            {
            ...
            {
                orm: this.betopiaerpDataProvider.orm,
                serverData: this.betopiaerpDataProvider.serverData,
    ...
    /**
     * @param {import("@betopiaerp/o-spreadsheet").Maybe<FunctionResultObject>[]} args
     *
     * @returns {PivotDomain}
     */
        ...
        await Promise.all(
            related.map((dimension) =>
                getRelationalFieldDefinition(
                    ...
                    dimension.fieldName,
                    this.betopiaerpDataProvider.fieldService
    ...
    async _loadPropertiesDefinitions() {
        ...
        const orm = this.betopiaerpDataProvider.orm;
...
export class BetopiaERPPivotRuntimeDefinition extends PivotRuntimeDefinition {
    /**
     * @param {BetopiaERPPivotCoreDefinition} definition
     * @param {BetopiaERPFields} fields
     */
...
supportedPivotPositionalFormulaRegistry.add("BETOPIAERP", true);
