import { AbstractChart, CommandResult } from "@betopiaerp/o-spreadsheet";
 ...
 *
 * @typedef BetopiaERPChartDefinition
 ...
 *
 * @typedef BetopiaERPChartDefinitionDataSource
 * @property {MetaData} metaData
 * @property {SearchParams} searchParams
 *
 */

export class BetopiaERPChart extends AbstractChart {
    /**
     * @param {BetopiaERPChartDefinition} definition
    ...
    static getDefinitionFromContextCreation() {
        throw new Error("It's not possible to convert an BetopiaERP chart to a native chart");
    }

    /**
     * @returns {BetopiaERPChartDefinitionDataSource}
     */
    ...
    /**
     * @returns {BetopiaERPChartDefinition}
     */
    getDefinition() {
        return {
