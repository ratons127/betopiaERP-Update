...
/**
 * @typedef {import("@spreadsheet").BetopiaERPField} BetopiaERPField
 * @typedef {import("@spreadsheet").BetopiaERPFields} BetopiaERPFields
 */

/**
 * @typedef {Object} BetopiaERPModelMetaData
 * @property {string} resModel
 * @property {BetopiaERPFields} [fields]
 *
 * @typedef {Object} BetopiaERPModelSearchParams
 * @property {Object} context
 * @property {Array<string>} domain
 */

export class BetopiaERPViewsDataSource extends LoadableDataSource {
    /**
     * @override
     * @param {Object} services
     * @param {Object} params
     * @param {BetopiaERPModelMetaData} params.metaData
     * @param {Object} params.searchParams
     */
    constructor(services, params) {
        super(services);
        /** @type {BetopiaERPModelMetaData} */
    ...
    /**
     * @returns {BetopiaERPFields} List of fields
     */
    getFields() {
     ...
     * @returns {BetopiaERPField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
