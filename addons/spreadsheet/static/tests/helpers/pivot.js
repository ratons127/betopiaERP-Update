...
async function insertStaticPivot(model, pivotId, params) {
    ...
    if (!(ds instanceof BetopiaERPPivot)) {
        throw new Error("The pivot data source is not an BetopiaERPPivot");
    }
 ...
 * @returns {Promise<{ model: BetopiaERPSpreadsheetModel, env: object, pivotId: string}>}
 */
