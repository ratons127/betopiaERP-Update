    ...
    def test_generate_oauth2_string_token(self):
        ...
        for (
            ...
            with self.subTest(currenct_datetime=current_datetime), \
                ...
                mock.patch("betopiaerp.addons.google_gmail.models.google_gmail_mixin._logger.info") as mock_logger, \
                mock.patch(
                    "betopiaerp.addons.google_gmail.models.google_gmail_mixin.GoogleGmailMixin._fetch_gmail_access_token",
