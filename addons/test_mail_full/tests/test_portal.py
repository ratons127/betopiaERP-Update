...
from betopiaerp.addons.auth_signup.models.res_partner import ResPartner
from betopiaerp.addons.mail.tests.common import MailCommon
from betopiaerp.addons.test_mail_full.tests.common import TestMailFullCommon
from betopiaerp.addons.test_mail_sms.tests.common import TestSMSRecipients
from betopiaerp.exceptions import AccessError
from betopiaerp.tests import tagged, users
from betopiaerp.tests.common import HttpCase
from betopiaerp.tools import html_escape, mute_logger
...
class TestPortalControllers(TestPortal):
    ...
    def test_portal_share_comment(self):
        ...
        # Only messages from the current user not BetopiaERPBot
...
class TestPortalFlow(MailCommon, HttpCase):
    ...
    def setUpClass(cls):
        ...
        cls.internal_backend_local_url = f'/betopiaerp/{cls.record_internal._name}/{cls.record_internal.id}'
        cls.portal_backend_local_url = f'/betopiaerp/{cls.record_portal._name}/{cls.record_portal.id}'
        cls.read_backend_local_url = f'/betopiaerp/{cls.record_read._name}/{cls.record_read.id}'
        cls.public_act_url_backend_local_url = f'/betopiaerp/{cls.record_public_act_url._name}/{cls.record_public_act_url.id}'
        cls.discuss_local_url = '/betopiaerp/action-mail.action_discuss'
