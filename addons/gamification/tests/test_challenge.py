...
from betopiaerp.addons.gamification.tests.common import TransactionCaseGamification
...
class test_challenge(TestGamificationCommon):
    ...
    @mute_logger('betopiaerp.models.unlink', 'betopiaerp.addons.mail', 'betopiaerp.addons.auth_signup')
