...
from betopiaerp.tests import HOST, HttpCase
from betopiaerp.tools import DotDict, config, frozendict
from betopiaerp.tools.urls import urljoin as url_join
...
def MockRequest(
    ...
    request = Mock(
        ...
        type='http',
        future_response=betopiaerp.http.FutureResponse(),
        params={},
        ...
        geoip=betopiaerp.http.GeoIP('127.0.0.1'),
    ...
    if country_code or city_name:
        try:
            request.geoip._city_record = betopiaerp.http.geoip2.models.City(['en'], country=(country_code and {'iso_code': country_code}) or {}, city=(city_name and {'names': {'en': city_name}}) or {})
        except TypeError:
            request.geoip._city_record = betopiaerp.http.geoip2.models.City({'country': (country_code and {'iso_code': country_code}) or {}, 'city': (city_name and {'names': {'en': city_name}}) or {}})
    ...
    #
    #   router = betopiaerp.http.root.get_db_router()
    ...
    with contextlib.ExitStack() as s:
        ...
        s.callback(betopiaerp.http._request_stack.pop)
        s.enter_context(patch('betopiaerp.http.root.get_db_router', router))
