...
from betopiaerp.tools import email_normalize_all, float_round

from betopiaerp.addons.payment import utils as payment_utils
from betopiaerp.addons.payment.const import SENSITIVE_KEYS
...
class PaymentTransaction(models.Model):
    ...
    def _validate_amount(self, payment_data):
        ...
        # Negate the amount for refunds, as refunds have a negative amount in BetopiaERP, but all
    ...
    def _send_api_request(self, method, endpoint, *, params=None, data=None, json=None, **kwargs):
        ...
        1. Pass the transaction reference to the provider's
           :meth:`~betopiaerp.addons.payment.models.payment_provider.PaymentProvider._send_api_request`
           method.
