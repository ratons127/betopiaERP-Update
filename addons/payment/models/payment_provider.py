...
from betopiaerp.addons.payment.const import REPORT_REASONS_MAPPING, SENSITIVE_KEYS
...
class PaymentProvider(models.Model):
    ...
    module_to_buy = fields.Boolean(string="BetopiaERP Enterprise Module", related='module_id.to_buy')
