...
from betopiaerp import tools, fields
from betopiaerp.addons.base.models.ir_mail_server import IrMail_Server
from betopiaerp.addons.base.tests.common import MockSmtplibCase
from betopiaerp.addons.bus.models.bus import BusBus, json_dump
from betopiaerp.addons.bus.tests.common import BusCase
from betopiaerp.addons.mail.models import mail_thread
from betopiaerp.addons.mail.models.mail_mail import MailMail
from betopiaerp.addons.mail.models.mail_message import MailMessage
from betopiaerp.addons.mail.models.mail_notification import MailNotification
from betopiaerp.addons.mail.models.res_users import ResUsers
from betopiaerp.addons.mail.tools.discuss import Store
from betopiaerp.tests import common, RecordCapturer, new_test_user
from betopiaerp.tools import mute_logger
from betopiaerp.tools.mail import (
    email_normalize, email_normalize_all, email_split, email_split_and_format_normalize, formataddr
)
from betopiaerp.tools.translate import code_translations
...
class MockEmail(common.BaseCase, MockSmtplibCase):
    ...
    def mock_push_to_end_point(self, max_direct_push=5):
        with patch.object(mail_thread, 'push_to_end_point') as patched_push, \
             patch('betopiaerp.addons.mail.models.mail_thread.MAX_DIRECT_PUSH', max_direct_push):
...
class MailCommon(MailCase):
    ...
    def _activate_multi_lang(cls, lang_code='es_ES', layout_arch_db=None, test_record=False, test_template=False):
        ...
        with mute_logger("betopiaerp.addons.base.models.ir_module", "betopiaerp.tools.translate"):
...
<body>
    ...
    def _setup_push_devices_for_partners(cls, partners, endpoint=None):
        ...
        endpoint = endpoint or "https://test.betopiaerp.com/webpush/user"
...
def freeze_all_time(dt=None):
    ...
    with patch('betopiaerp.sql_db.BaseCursor.now', return_value=dt), freeze_time(dt):
        yield
