...
class TestMailComposerForm(TestMailComposer):
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_rule', 'betopiaerp.addons.mail.models.mail_mail')
    @users('employee')
...
class TestMailComposerUI(MailCommon, HttpCase):
    ...
    def test_send_attachment_without_body(self):
        self.start_tour("/betopiaerp/discuss", "create_thread_for_attachment_without_body",login="admin")
