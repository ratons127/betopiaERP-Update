...
from betopiaerp.tests import TransactionCase, mute_logger
...
class TestFetchmail(TransactionCase):
    ...
    def test_fetchmail_deactivation(self):
        ...
        with (
            ...
            mute_logger('betopiaerp.addons.mail.models'),
            self.assertLogs('betopiaerp.addons.base.models.ir_cron') as cron_log_catcher,
        ):
            ...
            self.assertIn('WARNING:betopiaerp.addons.base.models.ir_cron:Deactivating fetchmail imap server test deactivation server (too many failures)', cron_log_catcher.output)
