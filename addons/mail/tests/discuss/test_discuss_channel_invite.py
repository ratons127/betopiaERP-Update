...
from betopiaerp.tests import HttpCase, new_test_user, tagged, users
...
class TestDiscussChannelInvite(HttpCase, MailCommon):
    def test_01_invite_by_email_flow(self):
        ...
        with self.mock_mail_gateway():
            self.start_tour(
                f"/betopiaerp/discuss?active_id={group_chat.id}", "discuss.invite_by_email", login="bob"
            )
    ...
    def test_05_search_for_channel_invite_selectable_email(self):
        ...
        cases = [
            ...
            *product(
                ...
                ["bob@betopiaerp.com", "alfred@betopiaerp.com", "jane@betopiaerp.com"],
                [False],
            ),
