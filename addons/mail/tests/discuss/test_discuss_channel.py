...
from betopiaerp.addons.bus.models.bus import json_dump
from betopiaerp.addons.mail.models.discuss.discuss_channel import channel_avatar, group_avatar
...
from betopiaerp.tests import HttpCase, tagged, users
