...
class TestLoadMessages(HttpCaseWithUserDemo):
    def test_01_mail_message_load_order_tour(self):
        ...
        self.env["mail.message"].create([{
            ...
            "pinned_at": betopiaerp.fields.Datetime.now() if n == 1 else None,
        ...
        self.start_tour("/betopiaerp/action-mail.action_discuss", "mail_message_load_order_tour", login="admin")
