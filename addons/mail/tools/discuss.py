...
from betopiaerp.addons.bus.websocket import wsrequest
    ...
    def _add_values(self, values, model_name, index=None):
        ...
        for key, val in values.items():
            ...
            if isinstance(val, Store.Relation):
                ...
                target[key] = betopiaerp.fields.Datetime.to_string(val)
            elif isinstance(val, date):
                target[key] = betopiaerp.fields.Date.to_string(val)
