...
from betopiaerp import api, exceptions, models, tools, _
from betopiaerp.addons.mail.tools.alias_error import AliasError
from betopiaerp.tools import parse_contact_from_email
from betopiaerp.tools.mail import email_normalize, email_split_and_format
from betopiaerp.tools.sql import column_exists
...
class Base(models.AbstractModel):
    ...
    def _notify_by_email_get_headers(self, headers=None):
        ...
        if not self:
            return headers
        self.ensure_one()
        headers['X-BetopiaERP-Objects'] = f"{self._name}-{self.id}"
