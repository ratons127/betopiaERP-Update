...
from betopiaerp import api, fields, release, SUPERUSER_ID
from betopiaerp.exceptions import UserError
from betopiaerp.models import AbstractModel
...
class Publisher_WarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to BetopiaERP's publisher warranty server to check the
