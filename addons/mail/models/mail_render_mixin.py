...
from betopiaerp import _, api, fields, models, tools
from betopiaerp.addons.base.models.ir_qweb import QWebError
from betopiaerp.exceptions import UserError, AccessError
from betopiaerp.tools import urls
from betopiaerp.tools.mail import is_html_empty, prepend_html_content, html_normalize
from betopiaerp.tools.rendering_tools import convert_inline_template_to_qweb, parse_inline_template, render_inline_template, template_env_globals
...
class MailRenderMixin(models.AbstractModel):
    ...
    def _render_template(self, template_src, model, res_ids, engine='inline_template',
        ...
        :param list res_ids: list of ids of records. All should belong to the
          BetopiaERP model given by model;
