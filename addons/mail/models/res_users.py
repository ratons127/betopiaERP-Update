...
from betopiaerp import _, api, Command, fields, models, modules, tools
from betopiaerp.exceptions import UserError
from betopiaerp.http import request
from betopiaerp.tools import email_normalize, str2bool
...
class ResUsers(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        help="Policy on how to handle Chatter notifications:\n"
             ...
             "- In BetopiaERP: notifications appear in your BetopiaERP Inbox")
    ...
    _notification_type = models.Constraint(
        ...
        'Only internal user can receive notifications in BetopiaERP',
    )
