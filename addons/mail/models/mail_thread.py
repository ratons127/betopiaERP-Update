...
from betopiaerp import _, api, exceptions, fields, models, tools
from betopiaerp.addons.mail.tools.discuss import Store
from betopiaerp.addons.mail.tools.web_push import (
    push_to_end_point, DeviceUnreachableError,
    ENCRYPTION_BLOCK_OVERHEAD, ENCRYPTION_HEADER_SIZE, MAX_PAYLOAD_SIZE
)
from betopiaerp.exceptions import MissingError, AccessError
...
class MailThread(models.AbstractModel):
    ...
    def message_post(self, *,
        ...
        :param str outgoing_email_to: comma-separated list of emails to notify in
            addition to partner_ids. Experimental support as of BetopiaERP v19;
    ...
    def _notify_by_email_get_base_mail_values(self, message, recipients_data, additional_values=None):
        ...
        # SES SMTP may replace Message-Id and In-Reply-To refers an internal ID not stored in BetopiaERP)
    ...
    def _notify_get_recipients_classify(self, message, recipients_data,
        ...
        :return: list of groups (see '_notify_get_recipients_groups')
          with 'recipients' key filled with matching partners, like
            [{
                'active': True,
                'button_access': {'url': 'https://betopiaerp.com/url', 'title': 'Title'},
                'has_button_access': False,
    ...
    def _notify_get_recipients_for_extra_notifications(self, message, recipients_data, msg_vals=False):
        """ Never send to author and to people outside BetopiaERP (email) except comments """
        notif_pids = []
        notif_pids_notinbox = []
