...
registry.category("web_tour.tours").add("can_create_channel_from_form_view", {
    steps: () => [
        {
            trigger: ".o-mail-DiscussSidebarChannel-itemName:contains(BetopiaERPBot)",
            run: "click",
        },
        {
            trigger: ".o-mail-DiscussContent-threadName[title='BetopiaERPBot']",
        },
        ...
        {
            trigger: ".breadcrumb-item:contains('BetopiaERPBot')",
            run: "click",
        },
        {
