...
import { __debug__, after, afterEach, expect, getFixture } from "@betopiaerp/hoot";
 ...
 *
 * @param {import("@betopiaerp/hoot-dom").Target} selector
 ...
 *  element.
 * @property {HTMLElement|BetopiaERPEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when BetopiaERPEnv, special key `target`. See @start
