...
test("Posting message should transform links.", async () => {
    ...
    await start();
    await openDiscuss(channelId);
    await insertText(".o-mail-Composer-input", "test https://www.BetopiaERP.com/");
    await press("Enter");
    await contains("a[href='https://www.BetopiaERP.com/']");
});
...
test("Partner IM status is displayed as thread icon in top bar of channels of type 'chat'", async () => {
    ...
    await click(".o-mail-DiscussSidebarChannel", { text: "BetopiaERPBot" });
