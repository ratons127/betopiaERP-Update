...
from betopiaerp.tests import Form, HttpCase, tagged, warmup
from betopiaerp.addons.mail.tests.common import MailCase
from betopiaerp.addons.marketing_card.controllers.marketing_card import SOCIAL_NETWORK_USER_AGENTS
...
class TestMarketingCardRender(MarketingCardCommon):
    ...
    def test_campaign(self):
        ...
        with patch('betopiaerp.addons.marketing_card.models.card_campaign.CardCampaign._get_model_selection',
    ...
    def test_fetch_datetime(self):
        ...
        for tz in timezones:
            ...
            with patch(
                    'betopiaerp.addons.mail.models.models.Base._mail_get_timezone',
                    lambda model: tz
            ):
