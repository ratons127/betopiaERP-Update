...
from betopiaerp.addons.mail_group.tests.data import GROUP_TEMPLATE
from betopiaerp.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('betopiaerp.models.unlink', 'betopiaerp.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_rule', 'betopiaerp.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_thread', 'betopiaerp.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_thread', 'betopiaerp.addons.mail_group.models.mail_group_message', 'betopiaerp.models.unlink')
    @users('employee')
    ...
    @mute_logger('betopiaerp.addons.mail_group.models.mail_group')
    @users('employee')
