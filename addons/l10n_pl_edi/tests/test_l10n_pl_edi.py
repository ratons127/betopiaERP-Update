...
from betopiaerp import Command, fields, tools
from betopiaerp.exceptions import UserError
from betopiaerp.tests import freeze_time, patch, tagged

from betopiaerp.addons.account.tests.common import AccountTestInvoicingCommon
from betopiaerp.addons.l10n_pl_edi.tools.ksef_api_service import KsefApiService
...
class TestL10nPlEdi(AccountTestInvoicingCommon):
    ...
    def test_ksef_fa3_standard_vat(self):
        ...
        This test verifies that a regular BetopiaERP invoice (not a down payment or correction)
    ...
    def l10n_pl_edi_generate_attachments(self, invoices, from_cron=False):
        ...
        with patch('betopiaerp.addons.l10n_pl_edi.models.account_move_send.AccountMoveSend._call_web_service_before_invoice_pdf_render'):
