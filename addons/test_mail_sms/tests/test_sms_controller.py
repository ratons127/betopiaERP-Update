...
from betopiaerp.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
...
class TestSmsController(TestSMSActionsCommon):
    ...
    @mute_logger("betopiaerp.addons.base.models.ir_http")
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_http', 'betopiaerp.addons.sms.controllers.main', 'betopiaerp.http')
