...
from betopiaerp.addons.sms.tests import common as sms_common
from betopiaerp.addons.test_mail.tests.test_performance import BaseMailPerformance
...
class TestSMSPerformance(BaseMailPerformance, sms_common.SMSCase):
    ...
    @mute_logger('betopiaerp.addons.sms.models.sms_sms')
    @users('employee')
    @warmup
