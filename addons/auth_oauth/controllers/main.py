...
from betopiaerp import api, http, SUPERUSER_ID, _
...
from betopiaerp.addons.auth_signup.controllers.main import AuthSignupHome as Home
from betopiaerp.addons.web.controllers.utils import ensure_db, _get_login_redirect_url
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via BetopiaERP Account provider"""
