...
from betopiaerp.addons.point_of_sale.models.pos_order import PosOrder
...
class TestL10nEsEdiVerifactuPosOrder(TestL10nEsEdiVerifactuPosCommon):
    ...
    def _create_order(self, data):
        ...
        if name:
            name_function_path = 'betopiaerp.addons.point_of_sale.models.pos_order.PosOrder._compute_order_name'
        ...
        if account_move:
            prepare_invoice_vals_function_path = 'betopiaerp.addons.point_of_sale.models.pos_order.PosOrder._prepare_invoice_vals'
