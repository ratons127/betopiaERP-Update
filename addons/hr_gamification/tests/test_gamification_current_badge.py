...
class TestGamificationBadge(TestHrCommon):
    ...
    def setUpClass(cls):
        ...
        .create([
            {
                "name": "demo_user",
                "login": "demo@betopiaerp.com",
                "email": "demo@betopiaerp.com",
                "group_ids": [Command.link(cls.env.ref("base.group_user").id)],
            }, {
                "name": "demo2_user",
                "login": "demo2@betopiaerp.com",
                "email": "demo2@betopiaerp.com",
                "group_ids": [Command.link(cls.env.ref("base.group_user").id)],
            }, {
                "name": "demo3_user",
                "login": "demo3@betopiaerp.com",
                "email": "demo3@betopiaerp.com",
                "group_ids": [Command.link(cls.env.ref("base.group_user").id)],
            }, {
                "name": "demo4_manager",
                "login": "demo4@betopiaerp.com",
                "email": "demo4@betopiaerp.com",
