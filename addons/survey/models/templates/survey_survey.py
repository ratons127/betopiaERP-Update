...
from betopiaerp import api, models, _
...
class SurveySurvey(models.Model):
    ...
    def _prepare_assessment_template_values(self):
        survey_values = {
            ...
            'description': ''.join([
                _('Welcome to this BetopiaERP certification. You will receive 2 random questions out of a pool of 3.'),
            ...
            'question_and_page_ids': [
                (0, 0, {  # survey.question
                    'title': _('BetopiaERP Certification'),
                    'is_page': True,
                    'question_type': False,
                ...
                (0, 0, {  # survey.question
                    'title': _('What does one need to get to pass an BetopiaERP Survey?'),
                    'question_type': 'simple_choice',
                    'suggested_answer_ids': [
                        (0, 0, {  # survey.question.answer
