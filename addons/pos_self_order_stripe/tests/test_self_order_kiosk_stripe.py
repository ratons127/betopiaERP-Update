...
from betopiaerp.tests import Command
...
class TestSelfOrderKioskStripe(SelfOrderCommonTest):
    ...
    def test_get_stripe_creditentials(self):
        ...
        stripe_connection_token = "betopiaerp.addons.pos_stripe.models.pos_payment_method.PosPaymentMethod.stripe_connection_token"
    ...
    def test_stripe_capture_payment(self):
        ...
        self.pos_config.open_ui()
        stripe_capture_payment = "betopiaerp.addons.pos_stripe.models.pos_payment_method.PosPaymentMethod.stripe_capture_payment"
