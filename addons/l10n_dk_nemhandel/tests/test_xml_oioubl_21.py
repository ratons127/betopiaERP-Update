...
from betopiaerp.addons.l10n_account_edi_ubl_cii_tests.tests.common import TestUBLCommon
...
class TestUBLDKOIOUBL21(TestUBLCommon, TestAccountMoveSendCommon):
    ...
    def _send_patched(cls, invoice):
        with patch('betopiaerp.addons.l10n_dk_nemhandel.models.res_partner.ResPartner._get_nemhandel_verification_state', return_value='not_valid'):
    ...
    def test_oioubl_export_import_with_discount(self):
        ...
        self._send_patched(invoice)
        self.assertTrue(invoice.ubl_cii_xml_id)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_betopiaerp/oioubl_out_invoice_discount.xml")
