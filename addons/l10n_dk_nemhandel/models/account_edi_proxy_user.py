...
from betopiaerp.addons.l10n_dk_nemhandel.tools.demo_utils import handle_demo
...
class AccountEdiProxyClientUser(models.Model):
    ...
    def _get_proxy_urls(self):
        ...
        urls['nemhandel'] = {
            'prod': 'https://nemhandel.api.betopiaerp.com',
            'test': 'https://nemhandel.test.betopiaerp.com',
            'demo': 'demo',
        }
        return urls
