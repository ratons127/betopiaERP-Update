...
from betopiaerp.addons.website_slides.tests import common as slides_common
from betopiaerp.exceptions import UserError
from betopiaerp.tests.common import HttpCase, users
...
class TestSlidesManagement(slides_common.SlidesCase, HttpCase):
    ...
    def test_default_completion_time(self):
        ...
        with patch(
            'betopiaerp.addons.website_slides.models.slide_slide.SlideSlide._get_completion_time_pdf',
