...
from betopiaerp.addons.base.tests.test_mimetypes import PNG
from betopiaerp.addons.mail.tests.common import mail_new_test_user
from betopiaerp.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('betopiaerp.models', 'betopiaerp.addons.base.models.ir_rule')
...
class TestAccessHttp(common.SlidesCase, HttpCase):
    @mute_logger('betopiaerp.models', 'betopiaerp.addons.base.models.ir_rule', 'betopiaerp.http')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('betopiaerp.models.unlink', 'betopiaerp.addons.base.models.ir_rule', 'betopiaerp.addons.base.models.ir_model')
...
class TestReview(common.SlidesCase, HttpCase):
    ...
    def test_channel_multiple_reviews(self):
        ...
        self.assertIn("betopiaerp.exceptions.ValidationError", res2.text)
