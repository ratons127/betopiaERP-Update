...
from betopiaerp import http, tests
from betopiaerp.addons.base.tests.common import HttpCaseWithUserPortal
from betopiaerp.addons.gamification.tests.common import HttpCaseGamification
from betopiaerp.fields import Command, Datetime
...
class TestUi(TestUICommon):
    ...
    @mute_logger("betopiaerp.http", "betopiaerp.addons.base.models.ir_rule", "werkzeug")
...
class TestUiPublisher(HttpCaseGamification):
    ...
    def fetch_proxy(self, url):
        if url.endswith('ThreeTimeAKCGoldWinnerPembrookeWelshCorgi.jpg'):
            ...
            with file_open('base/tests/betopiaerp.jpg', 'rb') as f:
                content = f.read()
