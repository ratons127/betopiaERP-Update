...
from betopiaerp.addons.payment_redsys.tests.common import RedsysCommon


@tagged('post_install', '-at_install')
class TestProcessingFlows(RedsysCommon, PaymentHttpCommon):

    @mute_logger('betopiaerp.addons.payment_redsys.controllers.main')
    def test_returning_from_payment_triggers_processing(self):
        ...
        with patch(
            'betopiaerp.addons.payment_redsys.controllers.main.RedsysController._verify_signature',
        ), patch(
