...
from betopiaerp import api, fields, models, _, tools
from betopiaerp.fields import Domain
from betopiaerp.exceptions import ValidationError, AccessError, RedirectWarning, UserError
from betopiaerp.tools import convert, format_time, email_normalize, SQL, Query
from betopiaerp.tools.intervals import Intervals
from betopiaerp.addons.hr.models.hr_version import format_date_abbr
from betopiaerp.addons.mail.tools.discuss import Store
from betopiaerp.tools.float_utils import float_is_zero
...
class HrEmployee(models.Model):
    ...
    def _check_access(self, operation):
        ...
        # Since BetopiaERP 19, one must have read access to the comodel to modify the
        # relation.
...
We can redirect you to the public employee list."""
    ...
    def create(self, vals_list):
        ...
        for employee in employees:
            ...
            url = '/betopiaerp/%s/action-hr.plan_wizard_action?active_model=hr.employee&menu_id=%s' % (employee.id, hr_root_menu.id)
