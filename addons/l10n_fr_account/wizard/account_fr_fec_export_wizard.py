...
import csv
import io
from betopiaerp.tools import float_is_zero, SQL
from betopiaerp import fields, models, api
...
class L10n_FrFecExportWizard(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # 1) the XSD file impose to have the label on the account.move, but BetopiaERP has the label on the account.move.line,
        # so that's a  problem !
