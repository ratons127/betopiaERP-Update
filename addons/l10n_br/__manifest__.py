# Part of BetopiaERP. See LICENSE file for full copyright and licensing details.
{
    ...
    'version': '1.1',
    'website': 'https://www.BetopiaERP.com/documentation/latest/applications/finance/fiscal_localizations/brazil.html',
...
configure BetopiaERP in order to properly use Avatax and send the needed fiscal
...
""",
    'author': 'Akretion, BetopiaERP Brasil',
    'depends': [
        'account',
        'account_qr_code_emv',
