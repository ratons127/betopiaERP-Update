...
from betopiaerp.addons.cloud_storage_azure.tests.test_cloud_storage_azure import TestCloudStorageAzureCommon


@betopiaerp.tests.tagged("-at_install", "post_install", "mail_controller")
class TestCloudStorageAttachmentController(HttpCaseWithUserDemo, TestCloudStorageAzureCommon):
    def test_cloud_storage_azure_attachment_upload(self):
        ...
        with patch(
            "betopiaerp.addons.cloud_storage_azure.utils.cloud_storage_azure_utils.requests.post", post
        ):
                                ...
                                "ir.attachment": [
                                    {
                                        ...
                                        "create_date": betopiaerp.fields.Datetime.to_string(
