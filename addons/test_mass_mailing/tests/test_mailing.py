...
from betopiaerp.tools import mute_logger, email_normalize
...
class TestMassMailing(TestMassMailCommon):
    ...
    def test_mailing_author(self):
        ...
        self.assertEqual(
            ...
            "When a mailing is sent by BetopiaERPBot, the author of the mails must be the author of the mailing."
        )
    ...
    def test_mailing_gateway_update(self):
        ...
        self.assertMailTraces(
            ...
            mailing, recipients,
            mail_links_info=[[
                ('url0', 'https://www.betopiaerp.tz/my/%s' % record.name, True, {}),
                ...
                ('url7', 'mailto:test@betopiaerp.com', False, {}),
        ...
        # simulate a click
        self.gateway_mail_trace_click(mailing, recipients[0], 'https://www.betopiaerp.be')
