...
from betopiaerp.tests import freeze_time, tagged, users
from betopiaerp.tools import mute_logger

from betopiaerp.addons.test_mail.tests.test_mail_composer import TestMailComposer
from betopiaerp.addons.test_mass_mailing.tests import common
...
class TestMailComposerMassMailing(TestMailComposer, common.TestMassMailCommon):
    ...
    @mute_logger('betopiaerp.addons.mass_mailing.models.mailing')
