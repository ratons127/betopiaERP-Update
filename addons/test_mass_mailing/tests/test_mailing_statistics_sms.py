...
class TestMailingStatistics(TestMassSMSCommon):
    ...
    @mute_logger('betopiaerp.addons.mass_mailing_sms.models.mailing_mailing', 'betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.addons.mail.models.mail_thread')
