...
from betopiaerp import _, Command
from betopiaerp.exceptions import UserError, RedirectWarning, AccessError
from betopiaerp.tests import tagged
from betopiaerp.tools import zeep
...
class TestL10nEsEdiVerifactuDocument(TestL10nEsEdiVerifactuCommon):
    ...
    def test_generation_error(self):
        check_function_path = 'betopiaerp.addons.l10n_es_edi_verifactu.models.verifactu_document.L10nEsEdiVerifactuDocument._check_record_values'
