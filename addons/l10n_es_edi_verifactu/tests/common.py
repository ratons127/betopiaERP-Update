...
from betopiaerp import _, release, Command
from betopiaerp.tools import file_open, html_sanitize, misc, zeep
...
class TestL10nEsEdiVerifactuCommon(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        db_identifier_function = 'betopiaerp.addons.l10n_es_edi_verifactu.models.verifactu_document.L10nEsEdiVerifactuDocument._get_db_identifier'
    ...
    def _mock_request(self, mock_response):
        request_function_path = 'betopiaerp.addons.l10n_es_edi_verifactu.models.verifactu_document.L10nEsEdiVerifactuDocument._soap_request'
    ...
    def _mock_get_zeep_operation(self, registration_return_value=None, registration_xml_return_value=None):
        request_function_path = 'betopiaerp.addons.l10n_es_edi_verifactu.models.verifactu_document._get_zeep_operation'
    ...
    def _mock_zeep_registration_operation(self, response_file_json, name=""):
        # Note: The real result is of type 'betopiaerp.tools.zeep.client.SerialProxy'; here it is a dict
    ...
    def _mock_cron_trigger(self, cron_trigger_result_dict):
        trigger_function_path = 'betopiaerp.addons.base.models.ir_cron.IrCron._trigger'
    ...
    def _mock_last_document(self, document):
        ...
        function_path = 'betopiaerp.addons.l10n_es_edi_verifactu.models.res_company.ResCompany._l10n_es_edi_verifactu_get_last_document'
