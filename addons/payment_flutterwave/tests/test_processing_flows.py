...
from betopiaerp.addons.payment_flutterwave.tests.common import FlutterwaveCommon


@tagged('post_install', '-at_install')
class TestProcessingFlows(FlutterwaveCommon, PaymentHttpCommon):

    @mute_logger('betopiaerp.addons.payment_flutterwave.controllers.main')
    ...
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'betopiaerp.addons.payment_flutterwave.controllers.main.FlutterwaveController.'
            '_verify_signature'
        ), patch(
            'betopiaerp.addons.payment.models.payment_transaction.PaymentTransaction._process'
        ) as process_mock:
