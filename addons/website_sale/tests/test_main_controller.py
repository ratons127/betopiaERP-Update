...
from betopiaerp.addons.payment.models.payment_provider import PaymentProvider
...
class TestPaymentProviderVisibility(PaymentHttpCommon, SaleCommon):
    ...
    def test_payment_provider_visibility_with_portal(self):
        ...
        with patch(
            'betopiaerp.addons.website_payment.models.payment_provider.PaymentProvider._get_compatible_providers',
