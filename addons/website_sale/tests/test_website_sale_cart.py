...
from betopiaerp.addons.product.tests.common import ProductVariantsCommon
from betopiaerp.addons.website_sale.controllers.cart import Cart
from betopiaerp.addons.website_sale.controllers.combo_configurator import (
    WebsiteSaleComboConfiguratorController,
)
from betopiaerp.addons.website_sale.controllers.main import WebsiteSale
from betopiaerp.addons.website_sale.controllers.payment import PaymentPortal
from betopiaerp.addons.website_sale.models.product_template import ProductTemplate
...
class TestWebsiteSaleCart(ProductVariantsCommon, WebsiteSaleCommon):
    ...
    def test_checkout_no_delivery_method_available(self):
        ...
        with (
            ...
            patch(
                'betopiaerp.addons.website_sale.models.sale_order.SaleOrder._get_preferred_delivery_method',
