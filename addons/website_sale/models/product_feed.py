...
from betopiaerp import SUPERUSER_ID, api, fields, models
from betopiaerp.exceptions import ValidationError
from betopiaerp.fields import Domain
from betopiaerp.http import request
from betopiaerp.tools import float_is_zero, float_round, urls

from betopiaerp.addons.website_sale import const, utils
...
class ProductFeed(models.Model):
    ...
    def _notify_website_manager(self, **kwargs):
        """Send a notification to the website manager using BetopiaERPBot.
