...
from betopiaerp.tools import SQL, clean_context, float_round, groupby, lazy, str2bool
from betopiaerp.tools.json import scriptsafe as json_scriptsafe
from betopiaerp.tools.translate import LazyTranslate, _

from betopiaerp.addons.payment import utils as payment_utils
from betopiaerp.addons.payment.controllers import portal as payment_portal
from betopiaerp.addons.sale.controllers import portal as sale_portal
from betopiaerp.addons.html_editor.tools import get_video_thumbnail
from betopiaerp.addons.website.controllers.main import QueryURL
from betopiaerp.addons.website.models.ir_http import sitemap_qs2dom
from betopiaerp.addons.website_sale.const import SHOP_PATH
from betopiaerp.addons.website_sale.models.website import (
...
def handle_product_params_error(exc, product, category=None, **kwargs):
    ...
    :param betopiaerp.exceptions.AccessError | betopiaerp.exceptions.MissingError exc: The exception thrown
...
class WebsiteSale(payment_portal.PaymentPortal):
    ...
    def add_product_media(self, media, type, product_product_id, product_template_id, combination_ids=None):
        ...
        if type == 'image':  # Image case
            ...
            media_create_data = [Command.create({
                'name': video_data.get('name', 'BetopiaERP Video'),
