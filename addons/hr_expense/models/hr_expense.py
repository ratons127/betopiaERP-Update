...
from betopiaerp import api, fields, Command, models, _
from betopiaerp.exceptions import RedirectWarning, UserError, ValidationError
from betopiaerp.tools import clean_context, email_normalize, float_repr, float_round, format_date, is_html_empty, parse_version
    ...
    def _get_base_account(self):
        ...
        if not account:
            raise UserError(self.env._(
                "BetopiaERP had a look at your expense, its product, your company and the journal but came back with empty hands.\n"
                "Give BetopiaERP a hand to find an account by setting up an expense account.\n"
