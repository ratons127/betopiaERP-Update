...
class TestLoyalty(TransactionCase):
    ...
    def test_discount_product_unlink(self):
        ...
        with mute_logger('betopiaerp.sql_db'), self.assertRaises(IntegrityError):
    ...
    def test_loyalty_mail(self):
        ...
        with patch('betopiaerp.addons.mail.models.mail_template.MailTemplate.send_mail', new=mock_send_mail):
