...
export class AccountingPlugin extends BetopiaERPUIPlugin {
    ...
    get serverData() {
        if (!this._serverData) {
            throw new Error(
                "'serverData' is not defined, please make sure a 'BetopiaERPDataProvider' instance is provided to the model."
            );
        }
