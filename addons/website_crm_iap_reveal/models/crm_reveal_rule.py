...
from betopiaerp.addons.crm.models import crm_stage
from betopiaerp.exceptions import ValidationError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap-services.betopiaerp.com'
...
class CrmRevealRule(models.Model):
    ...
    industry_tag_ids = fields.Many2many('crm.iap.lead.industry', string='Industries', help='Leave empty to always match. BetopiaERP will not create lead if no match')
    ...
    def _create_lead_from_response(self, result):
        ...
        template_values.update({
            'flavor_text': _("Opportunity created by BetopiaERP Lead Generation"),
