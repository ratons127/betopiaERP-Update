...
from betopiaerp.addons.im_livechat.tests import chatbot_common
from betopiaerp.tests.common import JsonRpcException, new_test_user, tagged
from betopiaerp.tools.misc import mute_logger
from betopiaerp.addons.mail.tests.common import freeze_all_time, MailCommon
...
class ChatbotCase(MailCommon, chatbot_common.ChatbotCase):
    ...
    def test_chatbot_steps(self):
        ...
        with self.assertRaises(JsonRpcException, msg='betopiaerp.exceptions.ValidationError'), mute_logger("betopiaerp.http"):
    ...
    def test_forward_to_specific_operator(self):
                            ...
                            "discuss.channel": [
                                {
                                    ...
                                    "name": "BetopiaERPBot Ernest Employee",
                                },
                            ],
                            "res.partner": self._filter_partners_fields(
                                {
        ...
        self.assertEqual(discuss_channel.name, "BetopiaERPBot Ernest Employee")
