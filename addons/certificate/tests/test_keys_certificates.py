...
from betopiaerp.tests import TransactionCase, tagged
...
class TestKeysCertificates(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.subject = cls.issuer = x509.Name([
            ...
            x509.NameAttribute(x509.oid.NameOID.ORGANIZATION_NAME, "BetopiaERP S.A."),
            x509.NameAttribute(x509.oid.NameOID.COMMON_NAME, "betopiaerp.com"),
        ])
