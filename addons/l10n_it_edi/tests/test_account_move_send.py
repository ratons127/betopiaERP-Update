...
from betopiaerp.addons.account.tests.test_account_move_send import TestAccountMoveSendCommon
from betopiaerp.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
from betopiaerp.addons.l10n_it_edi.tests.common import TestItEdi
...
class TestItAccountMoveSend(TestItEdi, TestAccountMoveSendCommon):
    ...
    def generate_l10n_it_edi_send_attachments(self, invoices, from_cron=False):
        ...
        with patch('betopiaerp.addons.l10n_it_edi.models.account_move_send.AccountMoveSend._call_web_service_after_invoice_pdf_render'):
    ...
    def test_invoice_multi_without_l10n_it_edi_xml_export(self):
        ...
        with patch(
                'betopiaerp.addons.account.models.account_move_send.AccountMoveSend._get_default_extra_edis',
    ...
    def test_invoice_send_with_multiple_company(self):
        ...
        with patch('betopiaerp.addons.l10n_it_edi.models.account_move.AccountMove._l10n_it_edi_upload_single', return_value={}, autospec=True) as mock_check:
    ...
    def test_l10n_it_edi_send_success(self):
        ...
        with patch('betopiaerp.addons.l10n_it_edi.models.account_move.AccountMove._l10n_it_edi_upload_single', return_value=success) as mock_check:
    ...
    def test_l10n_it_edi_send_proxy_error(self):
        ...
        with patch('betopiaerp.addons.l10n_it_edi.models.account_move.AccountMove._l10n_it_edi_upload_single', return_value=proxy_error) as mock_check:
            attachments_vals = {invoice: {'name': invoice.l10n_it_edi_attachment_name, 'raw': invoice.l10n_it_edi_attachment_file}}
            results = invoice._l10n_it_edi_send(attachments_vals)
    ...
    def test_l10n_it_edi_send_proxy_exception(self):
        invoice = self.init_invoice(self.italian_partner_a)
        self.generate_l10n_it_edi_send_attachments(invoice)
        with patch('betopiaerp.addons.l10n_it_edi.models.account_move.AccountMove._l10n_it_edi_upload_single', side_effect=AccountEdiProxyError('error_code', message='error_description')) as mock_check:
            attachments_vals = {invoice: {'name': invoice.l10n_it_edi_attachment_name, 'raw': invoice.l10n_it_edi_attachment_file}}
            results = invoice._l10n_it_edi_send(attachments_vals)
    ...
    def test_l10n_it_edi_send_from_cron(self):
        ...
        with patch('betopiaerp.addons.l10n_it_edi.models.account_move.AccountMove._l10n_it_edi_upload_single', side_effect=_l10n_it_edi_upload_single, autospec=True) as mock_check:
