...
from betopiaerp.addons.base.models.ir_qweb_fields import Markup, nl2br, nl2br_enclose
from betopiaerp.exceptions import LockError, UserError
from betopiaerp.tools import cleanup_xml_node, float_compare, float_is_zero, float_repr, float_round, html2plaintext
from betopiaerp.tools.sql import column_exists, create_column

from betopiaerp import _, api, Command, fields, models, modules
from betopiaerp.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
from betopiaerp.addons.l10n_it_edi.models.account_payment_method_line import L10N_IT_PAYMENT_METHOD_SELECTION
from betopiaerp.addons.l10n_it_edi.tools.remove_signature import remove_signature
...
class AccountMove(models.Model):
    ...
    def _l10n_it_edi_import_invoice(self, invoice, data, is_new):
        """ Decode a FatturaPA attachment into an BetopiaERP move.
