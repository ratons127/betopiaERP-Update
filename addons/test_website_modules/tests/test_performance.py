...
from betopiaerp.addons.website.tests.test_performance import TestWebsitePerformanceCommon
from betopiaerp.addons.website_sale.tests.common import WebsiteSaleCommon
from betopiaerp.addons.website_sale.tests.test_website_sale_pricelist import TestWebsitePriceList
...
class TestWebsiteAllPerformance(TestWebsitePerformanceCommon, TestWebsitePriceList, WebsiteSaleCommon):
    ...
    def test_website_user_id_public_user(self):
        origin_serve_page = betopiaerp.addons.website.models.ir_http.IrHttp._serve_page
        ...
        with patch('betopiaerp.addons.website.models.ir_http.IrHttp._serve_page', wraps=_serve_page) as mocked:
    ...
    def test_perf_sql_queries_page(self):
        ...
        origin_allow_to_use_cache = betopiaerp.addons.website.models.website_page.WebsitePage._allow_to_use_cache
        ...
        with patch('betopiaerp.addons.website.models.website_page.WebsitePage._allow_to_use_cache', wraps=_allow_to_use_cache) as mocked:
            self.url_open(self.page.url)
            mocked.assert_called_once()
