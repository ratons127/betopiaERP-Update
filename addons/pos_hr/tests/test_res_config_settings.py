...
from betopiaerp.addons.pos_hr.tests.test_frontend import TestPosHrHttpCommon
from betopiaerp.addons.point_of_sale.tests.test_res_config_settings import TestConfigureShops
