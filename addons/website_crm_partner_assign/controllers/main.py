...
from betopiaerp.addons.website_google_map.controllers.main import GoogleMap
from betopiaerp.addons.website_partner.controllers.main import WebsitePartnerPage
