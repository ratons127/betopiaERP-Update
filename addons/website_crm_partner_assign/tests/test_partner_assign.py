...
from betopiaerp.tests.common import tagged, new_test_user, TransactionCase
from betopiaerp.tools import mute_logger

from betopiaerp.addons.base.tests.common import HttpCase
from betopiaerp.addons.crm.tests.common import TestCrmCommon
from betopiaerp.addons.mail.controllers.thread import ThreadController
...
from betopiaerp.addons.website_crm_partner_assign.controllers.main import (
    WebsiteAccount,
...
class TestPartnerAssign(TransactionCase):
    ...
    def setUp(self):
        ...
        patcher = patch('betopiaerp.addons.base_geolocalize.models.base_geocoder.BaseGeocoder.geo_find', wraps=geo_find)
...
class TestPartnerLeadPortal(TestCrmCommon, HttpCase):
    ...
    @patch('betopiaerp.http.GeoIP')
    def test_03_crm_partner_assign_geolocalization(self, GeoIpMock):
        """
            This test checks situation when "{BetopiaERPURL}/partners" is visited from foreign country without resellers.
        ...
        """
        # Patch GeoIp so it acts, as if BetopiaERP client is located in Mexico
