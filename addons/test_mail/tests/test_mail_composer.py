...
from betopiaerp.addons.mail.wizard.mail_compose_message import MailComposeMessage
...
from betopiaerp.fields import Datetime as FieldDatetime
from betopiaerp.exceptions import AccessError, UserError
from betopiaerp.tests import Form, tagged, users
from betopiaerp.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('betopiaerp.tests', 'betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.models.unlink')
    ...
    @mute_logger('betopiaerp.tests', 'betopiaerp.addons.base.models.ir_rule', 'betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('betopiaerp.models.unlink', 'betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.addons.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('betopiaerp.models.unlink', 'betopiaerp.addons.mail.models.mail_mail')
