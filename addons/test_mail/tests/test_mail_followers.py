...
from betopiaerp.addons.mail.models.mail_mail import _UNFOLLOW_REGEX
...
class UnfollowLinkTest(MailCommon, HttpCase):
    ...
    @mute_logger('betopiaerp.addons.base.models', 'betopiaerp.addons.mail.controllers.mail', 'betopiaerp.http', 'betopiaerp.models')
