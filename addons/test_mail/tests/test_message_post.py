...
from betopiaerp.addons.base.tests.test_ir_cron import CronMixinCase
from betopiaerp.addons.mail.tests.common import mail_new_test_user, MailCommon
from betopiaerp.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from betopiaerp.addons.test_mail.models.test_mail_models import MailTestSimple
from betopiaerp.addons.test_mail.tests.common import TestRecipients
from betopiaerp.service.model import call_kw
from betopiaerp.exceptions import AccessError
from betopiaerp.tests import tagged
from betopiaerp.tools import mute_logger, formataddr
from betopiaerp.tests.common import users
...
class TestMessageNotify(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.models.unlink', 'betopiaerp.tests')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.models.unlink')
    @users('employee')
    def test_message_post(self):
        ...
        exp_headers = {
            ...
            'X-BetopiaERP-Objects': f'{test_record._name}-{test_record.id}',
        }
        with self.assertSinglePostNotifications(
                [
                    {'partner': self.partner_employee_2, 'type': 'inbox'},
                ...
                with self.assertSinglePostNotifications(
                        ...
                        message_info={
                            ...
                            'mail_mail_values': {
                                'headers': {
                                    'Return-Path': f'{expected_alias_domain.bounce_alias}@{expected_alias_domain.name}',
                                    'X-BetopiaERP-Objects': f'{record._name}-{record.id}',
                                },
                            },
                            'message_values': {
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.tests')
    ...
    @users('employee')
    @mute_logger('betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.addons.mail.models.mail_message_schedule', 'betopiaerp.models.unlink')
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_model', 'betopiaerp.addons.mail.models.mail_mail')
