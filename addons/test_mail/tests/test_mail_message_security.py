...
from betopiaerp.addons.test_mail.models.mail_test_access import MailTestAccess
...
class TestMailMessageAccess(MessageAccessCommon):
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_model', 'betopiaerp.addons.base.models.ir_rule')
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_rule')
