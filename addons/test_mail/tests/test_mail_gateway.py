...
from betopiaerp import exceptions
from betopiaerp.addons.mail.models.mail_message import MailMessage
from betopiaerp.addons.mail.models.mail_thread import MailThread
from betopiaerp.addons.mail.tests.common import mail_new_test_user, MailCommon
from betopiaerp.addons.test_mail.data import test_mail_data
from betopiaerp.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE, MAIL_TEMPLATE_EXTRA_HTML, THAI_EMAIL_WINDOWS_874
from betopiaerp.addons.test_mail.models.mail_test_ticket import MailTestTicket
from betopiaerp.addons.test_mail.models.test_mail_models import MailTestGateway, MailTestGatewayGroups
from betopiaerp.sql_db import Cursor
from betopiaerp.tests import Form, tagged, RecordCapturer
from betopiaerp.tools import mute_logger
from betopiaerp.tools.mail import email_normalize, email_split_and_format, formataddr
...
class TestEmailParsing(MailCommon):
    ...
    def test_message_parse_and_replace_binary_octetstream(self):
        ...
        with self.assertLogs('betopiaerp.addons.mail.models.mail_thread', level="WARNING") as capture:
        ...
        self.assertEqual(capture.output, [
            ("WARNING:betopiaerp.addons.mail.models.mail_thread:Message containing an unexpected "
    ...
    def test_message_parse_eml(self):
        ...
        mail = self.format(test_mail_data.MAIL_EML_ATTACHMENT, email_from='"Sylvie Lelitre" <test.sylvie.lelitre@agrolait.com>', to=f'generic@{self.alias_domain}',
                           msg_id='<cb7eaf62-58dc-2017-148c-305d0c78892f@betopiaerp.com>',
                           references='<f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@betopiaerp.com>',
    ...
    def test_message_parse_extract_bounce_rfc822_headers_qp(self):
        ...
        incoming_bounce = self.format(
            ...
            email_from='MAILER-DAEMON@mailserver.betopiaerp.com (Mail Delivery System)',
            email_to='bounce@xxx.betopiaerp.com',
            delivered_to='bounce@xxx.betopiaerp.com'
        )
...
class TestMailgateway(MailGatewayCommon):
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_thread', 'betopiaerp.models')
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.addons.mail.models.mail_thread', 'betopiaerp.models.unlink', 'betopiaerp.tests')
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.addons.mail.models.mail_thread', 'betopiaerp.models')
        ...
        for email_to, test_user in itertools.product(email_tos, test_users):
            with self.subTest(test_user=test_user, email_to=email_to):
                ...
                self.assertEqual(new_messages.create_uid, self.user_root,
                                 'BetopiaERPbot should be creating the message')
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_thread', 'betopiaerp.models.unlink', 'betopiaerp.addons.mail.models.mail_mail')
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_thread', 'betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.models.unlink')
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_thread', 'betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.models', 'betopiaerp.sql_db')
    def test_message_process_alias_config_invalid_defaults(self):
        ...
        with self.mock_mail_gateway(), patch('betopiaerp.addons.mail.models.mail_alias.MailAlias._alias_bounce_incoming_email',
        ...
        with self.assertRaises(Exception), patch('betopiaerp.addons.mail.models.mail_alias.MailAlias._alias_bounce_incoming_email',
                                                 autospec=True) as _alias_bounce_incoming_email_mock:
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_thread', 'betopiaerp.models', 'betopiaerp.tests')
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_thread', 'betopiaerp.models.unlink')
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_thread', 'betopiaerp.models.unlink', 'betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.tests')
    ...
    def test_message_process_extra_model_res_id(self):
        ...
        # BetopiaERP 10 update: compat mode has been removed and should not work anymore
    ...
    def test_message_hebrew_iso8859_8_i(self):
        ...
        # python, check that BetopiaERP is still capable of decoding it.
...
class TestMailGatewayLoops(MailGatewayCommon):
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.addons.mail.models.mail_thread')
    ...
    def test_routing_loop_auto_notif(self):
        """ Test BetopiaERP servers talking to each other """
        with self.mock_mail_gateway():
            record = self.format_and_process(
                MAIL_TEMPLATE,
                self.other_partner.email_formatted,
    ...
    def test_routing_loop_follower_alias(self):
        ...
        # simulate this email coming back to the same BetopiaERP server -> msg_id is
...
class TestMailGatewayReplies(MailGatewayCommon):
        ...
        self.assertMailNotifications(
            ...
            [{
                ...
                'email_values': {
                    ...
                    'references': f'{email.message_id} {log.message_id} {reply.message_id}',  # should contain reference to BetopiaERPExternal message, logs to fill up history
                },
                'mail_mail_values': {
    ...
    def test_routing_reply_internal_messages(self):
        """ Test routing notably between two BetopiaERPs when internal messages
        ...
        Action                  BetopiaERP1                   BetopiaERP2
        RFQ-like                                        creation log
                                                        initial_msg
        BetopiaERP2 replies           creation log
                                reply                   reply
        -some internal work-                            user_notification
        BetopiaERP1 replies           reply_2                 reply_2 (incoming email)
        ...
        gateway_record.message_post(
            author_id=self.env.ref('base.partner_root').id,
            body='BetopiaERPExternal Inquiry',
