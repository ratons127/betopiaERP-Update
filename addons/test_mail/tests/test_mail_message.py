...
from betopiaerp.tests.common import tagged, users, HttpCase
from betopiaerp.tools import is_html_empty, mute_logger, formataddr
...
class TestMessageHelpersRobustness(MailCommon, HttpCase):
    ...
    def setUp(self):
        ...
        with mute_logger('betopiaerp.addons.mail.models.mail_mail'), self.mock_mail_gateway():
    ...
    def test_load_message_failures(self):
        ...
        with contextlib.suppress(Exception), mute_logger('betopiaerp.http', 'betopiaerp.sql_db'):  # suppress logged error due to readonly route doing an update
...
class TestMessageValues(MailCommon):
    ...
    @mute_logger('betopiaerp.models.unlink', 'betopiaerp.addons.mail.models.models')
    @users('employee')
