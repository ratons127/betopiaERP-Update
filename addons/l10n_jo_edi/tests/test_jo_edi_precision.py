...
from betopiaerp.addons.l10n_jo_edi.tests.jo_edi_common import JoEdiCommon
from betopiaerp.addons.l10n_jo_edi.models.account_edi_xml_ubl_21_jo import JO_MAX_DP
