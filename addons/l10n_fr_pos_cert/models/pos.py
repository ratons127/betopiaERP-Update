...
from betopiaerp import models, api, fields, release, _
...
class PosOrder(models.Model):
    ...
    pos_version = fields.Char(help="Version of BetopiaERP that created the order", readonly=True, copy=False)
    ...
    def _compute_string_to_hash(self):
        ...
        def collect_sorted_relational_ids(orders_data, lines_data, order_field_defs, line_field_defs):
            ...
            for model_name, ids in relational_ids.items():
                if ids:
                    # Use search() to get IDs sorted by _order the same way BetopiaERP ORM does for relational fields
