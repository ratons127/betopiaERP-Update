...
from betopiaerp import models, api, fields
from betopiaerp.fields import Datetime as FieldDateTime, Domain
...
class AccountSaleClosing(models.Model):
    ...
    def _interval_dates(self, frequency, company):
        ...
        @return {dict} the theoretical date from which account move lines are fetched.
            ...
            the dates are in their BetopiaERP Database string representation
        """
