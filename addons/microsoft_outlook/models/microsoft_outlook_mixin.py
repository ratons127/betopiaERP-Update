...
from betopiaerp.tools import hmac, email_normalize
from betopiaerp.tools.urls import urljoin as url_join
from betopiaerp.addons.google_gmail.tools import get_iap_error_message
...
class MicrosoftOutlookMixin(models.AbstractModel):
    ...
    _OUTLOOK_SCOPE = None
    _DEFAULT_OUTLOOK_IAP_ENDPOINT = 'https://outlook.api.betopiaerp.com'
