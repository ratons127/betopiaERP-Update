...
from betopiaerp.tests import new_test_user, tagged

from .dummy_methods import DummyMethods
from betopiaerp.addons.api_doc.controllers.api_doc import parse_signature
    ...
    def test_doc_access(self):
        ...
        for path in ('/doc', '/doc/index.json', '/doc/res.company.json'):
            with self.subTest(path=path):
                ...
                self.assertEqual(capture.output, [f'WARNING:betopiaerp.http:{e}'])
