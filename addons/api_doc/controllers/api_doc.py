...
import betopiaerp
from betopiaerp import http, models
from betopiaerp.api import Self
...
from betopiaerp.service.model import get_public_method
from betopiaerp.tools import hmac, json_default, lazy_classproperty, py_to_js_locale
...
DOC_API_MAGIC_COLUMNS = list(betopiaerp.models.MAGIC_COLUMNS)
...
# works much better than betopiaerp.tools.lazy.
class _DocUtils:
