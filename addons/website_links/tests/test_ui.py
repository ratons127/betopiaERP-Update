...
class TestUi(betopiaerp.tests.HttpCase):
    ...
    def setUp(self):
        ...
        patcher = patch('betopiaerp.addons.link_tracker.models.link_tracker.LinkTracker._get_title_from_url', wraps=_get_title_from_url)
