...
from betopiaerp.tests import tagged, JsonRpcException
from betopiaerp.tools import mute_logger

from betopiaerp.addons.account_payment.controllers.payment import PaymentPortal
from betopiaerp.addons.account_payment.controllers.portal import PortalAccount
...
from betopiaerp.addons.portal.controllers.portal import CustomerPortal
...
class TestFlows(AccountPaymentCommon, PaymentHttpCommon):
    ...
    def test_check_payment_access_token_before_rerouting_flow(self):
        ...
        ), patch('betopiaerp.addons.payment.utils.check_access_token') as check_payment_access_token_mock:
            try:
                payment_portal_controller._get_extra_payment_form_values(
                    invoice_id=self.invoice.id, access_token='whatever'
                )
    ...
    def test_invoice_overdue_payment_flow(self):
        ...
        self.authenticate('TestUser', 'BetopiaERP@123')
