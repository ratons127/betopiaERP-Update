...
from betopiaerp.tests import Form, TransactionCase, tagged
...
class TestVariants(ProductVariantsCommon):
    ...
    def test_variants_pricelist_code(self):
        vendor = self.env['res.partner'].create({'name': 'Bidou', 'email': 'bidou@betopiaerp.com'})
...
class TestVariantsExclusion(ProductVariantsCommon):
    ...
    def test_dynamic_variants_unarchive(self):
        ...
        with patch(
            'betopiaerp.addons.product.models.product_product.ProductProduct._filter_to_unlink',
