...
from betopiaerp.tools import float_compare, groupby
from betopiaerp.tools.image import is_image_size_above
from betopiaerp.tools.misc import unique
...
class ProductProduct(models.Model):
    ...
    def _unlink_or_archive(self, check_access=True):
        ...
        try:
            with self.env.cr.savepoint(), tools.mute_logger('betopiaerp.sql_db'):
                self.unlink()
        except Exception:
