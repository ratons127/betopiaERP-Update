...
class TestMailingControllers(TestMailingControllersCommon):
    ...
    @mute_logger('betopiaerp.http', 'betopiaerp.addons.website.models.ir_ui_view')
...
class TestMailingTracking(TestMailingControllersCommon):
    ...
    @mute_logger('betopiaerp.addons.mail.models.mail_mail', 'betopiaerp.addons.mass_mailing.models.mailing')
