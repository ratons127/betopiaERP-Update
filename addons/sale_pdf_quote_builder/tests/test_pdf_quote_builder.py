...
from betopiaerp.http import Response
from betopiaerp.tests import Form, tagged
from betopiaerp.tools.misc import file_open

from betopiaerp.addons.sale_management.tests.common import SaleManagementCommon
from betopiaerp.addons.sale_pdf_quote_builder.controllers.quotation_document import (
...
class TestPDFQuoteBuilder(SaleManagementCommon):
    ...
    def setUpClass(cls):
        ...
        cls.internal_user = cls._create_new_internal_user(login='internal.user@test.betopiaerp.com', groups='sales_team.group_sale_salesman')
    ...
    def test_quotation_document_upload_no_template(self):
        ...
        if 'website' not in self.env:
            ...
            from betopiaerp.addons.http_routing.tests.common import MockRequest  # noqa: PLC0415
