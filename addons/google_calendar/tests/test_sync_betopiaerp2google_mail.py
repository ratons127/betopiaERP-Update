...
from betopiaerp.addons.google_calendar.tests.test_sync_common import TestSyncGoogle
...
@tagged('betopiaerp2google')
class TestSyncBetopiaERP2GoogleMail(TestTokenAccess, TestSyncGoogle, MailCommon):
