...
from betopiaerp.addons.google_account.models.google_service import TIMEOUT
...
class GoogleCalendarSync(models.AbstractModel):
    ...
    def _is_google_insertion_blocked(self, sender_user):
        ...
        This is a necessary step for ensuring data match between BetopiaERP and Google,
