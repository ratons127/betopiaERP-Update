...
from betopiaerp.addons.calendar.controllers.main import CalendarController
from betopiaerp.addons.google_account.models.google_service import _get_client_secret
...
class GoogleCalendarController(CalendarController):
    ...
    def google_calendar_sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize BetopiaERP
            ...
            The dictionary may contains an url, to allow BetopiaERP Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted BetopiaERP to access his calendar !
