...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product, **values):
        ...
        :type product: :class:`~betopiaerp.addons.product.models.product.ProductProduct`
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type procurements: list of `~betopiaerp.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
