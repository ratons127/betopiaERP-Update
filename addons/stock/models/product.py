...
from betopiaerp.tools.barcode import check_barcode_encoding
from betopiaerp.tools.float_utils import float_compare
from betopiaerp.tools.mail import html2plaintext, is_html_empty
...
class ProductTemplate(models.Model):
    ...
    def _default_responsible_id(self):
        # Return the current user unless it's BetopiaERPBot
