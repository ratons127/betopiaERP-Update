...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("BetopiaERPBeforeTestHook", "BetopiaERPAfterTestHook"); // BetopiaERP customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("BetopiaERPBeforeTestHook"); // BetopiaERP customization
  	...
  	finish: async function finish() {
  		...
  		emit("BetopiaERPAfterTestHook", this);
