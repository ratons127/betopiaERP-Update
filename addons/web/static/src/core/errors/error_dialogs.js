...
export class ErrorDialog extends Component {
    ...
    static title = _t("BetopiaERP Error");
...
ClientErrorDialog.title = _t("BetopiaERP Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _t("BetopiaERP Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = _t("BetopiaERP Server Error");
                break;
            case "script":
                this.title = _t("BetopiaERP Client Error");
                break;
            case "network":
                this.title = _t("BetopiaERP Network Error");
                break;
        }
    }
...
export class RedirectWarningDialog extends Component {
    ...
    setup() {
        ...
        this.title = capitalize(subType) || _t("BetopiaERP Warning");
        this.message = message;
