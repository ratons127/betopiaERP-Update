    ...
    start(env) {
        ...
        browser.addEventListener("error", async (ev) => {
            ...
            if (isRedactedError) {
                ...
                uncaughtError.traceback =
                    `An error whose details cannot be accessed by the BetopiaERP framework has occurred.\n` +
        ...
        browser.addEventListener("unhandledrejection", async (ev) => {
            ...
            if (isBrowserChrome() && ev instanceof CustomEvent && error === undefined) {
                ...
                traceback =
                    ...
                    `An unknown error occured. This may be due to a Chrome extension meddling with BetopiaERP.\n` +
