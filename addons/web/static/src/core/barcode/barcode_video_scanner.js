...
import { Component, onMounted, onWillStart, onWillUnmount, status, useRef, useState } from "@betopiaerp/owl";
        ...
        onMounted(async () => {
            ...
            try {
                ...
                const errors = {
                    ...
                    NotAllowedError: _t("BetopiaERP needs your authorization first."),
                };
