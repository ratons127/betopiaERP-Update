...
(function (betopiaerp) {
    ...
    class ModuleLoader {
        /** @type {BetopiaERPModuleLoader["bus"]} */
        bus = new EventTarget();
        /** @type {BetopiaERPModuleLoader["checkErrorProm"]} */
        checkErrorProm = null;
        /** @type {BetopiaERPModuleLoader["factories"]} */
        factories = new Map();
        /** @type {BetopiaERPModuleLoader["failed"]} */
        failed = new Set();
        /** @type {BetopiaERPModuleLoader["jobs"]} */
        jobs = new Set();
        /** @type {BetopiaERPModuleLoader["modules"]} */
        modules = new Map();
        ...
        /** @type {BetopiaERPModuleLoader["addJob"]} */
        addJob(name) {
            this.jobs.add(name);
            this.startModules();
        }

        /** @type {BetopiaERPModuleLoader["define"]} */
        ...
        /** @type {BetopiaERPModuleLoader["findErrors"]} */
        ...
        /** @type {BetopiaERPModuleLoader["findJob"]} */
        findJob() {
        ...
        /** @type {BetopiaERPModuleLoader["reportErrors"]} */
        ...
        /** @type {BetopiaERPModuleLoader["startModules"]} */
        startModules() {
            let job;
        ...
        /** @type {BetopiaERPModuleLoader["startModule"]} */
        startModule(name) {
            /** @type {(dependency: string) => BetopiaERPModule} */
            const require = (dependency) => this.modules.get(dependency);
            this.jobs.delete(name);
            const factory = this.factories.get(name);
            /** @type {BetopiaERPModule | null} */
            let module = null;
            try {
