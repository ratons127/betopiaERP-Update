...
from betopiaerp.http import request, DEFAULT_MAX_CONTENT_LENGTH
from betopiaerp.tools import config
from betopiaerp.tools.misc import hmac, str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = betopiaerp.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.BetopiaERP.com/buy",
            "name": user.name,
            "username": user.login,
