...
class TestReports(betopiaerp.tests.HttpCase):
    def test_report_session_cookie(self):
        """ Asserts wkhtmltopdf forwards the user session when requesting resources to BetopiaERP, such as images,
    ...
    @mute_logger('betopiaerp.addons.base.models.ir_actions_report')
