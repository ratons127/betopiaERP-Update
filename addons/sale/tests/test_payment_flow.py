...
from betopiaerp.tests import JsonRpcException, tagged
from betopiaerp.tools import mute_logger

from betopiaerp.addons.account_payment.tests.common import AccountPaymentCommon
from betopiaerp.addons.http_routing.tests.common import MockRequest
from betopiaerp.addons.mail.tests.common import MailCase
from betopiaerp.addons.payment.tests.http_common import PaymentHttpCommon
from betopiaerp.addons.sale.controllers.portal import CustomerPortal
from betopiaerp.addons.sale.tests.common import SaleCommon
...
class TestSalePayment(AccountPaymentCommon, MailCase, PaymentHttpCommon, SaleCommon):
    ...
    @mute_logger('betopiaerp.http', 'werkzeug')
    ...
    def test_auto_confirm_and_auto_invoice(self):
        ...
        tx = self._create_transaction(flow='redirect', sale_order_ids=[self.sale_order.id], state='done')
        with (
            mute_logger('betopiaerp.addons.sale.models.payment_transaction'),
    ...
    def test_auto_done_and_auto_invoice(self):
        ...
        self.amount = self.sale_order.amount_total
        tx = self._create_transaction(flow='redirect', sale_order_ids=[self.sale_order.id], state='done')
        with mute_logger('betopiaerp.addons.sale.models.payment_transaction'):
            tx._post_process()
    ...
    def test_invoice_is_final(self):
        ...
        with mute_logger('betopiaerp.addons.sale.models.payment_transaction'), patch(
            'betopiaerp.addons.sale.models.sale_order.SaleOrder._create_invoices',
    ...
    def test_transaction_route_rejects_unexpected_kwarg(self):
        ...
        with self.assertRaises(JsonRpcException, msg='betopiaerp.exceptions.ValidationError'):
    ...
    def test_partial_payment_confirm_order(self):
        ...
        with patch(
            'betopiaerp.addons.sale.models.sale_order.SaleOrder._send_order_notification_mail',
