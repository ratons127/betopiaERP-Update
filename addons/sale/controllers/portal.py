...
from betopiaerp import SUPERUSER_ID, _, fields, http
from betopiaerp.exceptions import AccessError, MissingError, ValidationError
...
class CustomerPortal(payment_portal.PaymentPortal):
    ...
    def portal_order_page(
        ...
        **kw
        ...
        is_link_preview = request.httprequest.headers.get('BetopiaERP-Link-Preview')
        ...
        backend_url = f'/betopiaerp/action-{order_sudo._get_portal_return_action().id}/{order_sudo.id}'
        values = {
