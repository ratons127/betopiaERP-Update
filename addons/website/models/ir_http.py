...
import betopiaerp
from betopiaerp import api, models, tools
from betopiaerp import SUPERUSER_ID
...
from betopiaerp.addons.http_routing.models import ir_http
from betopiaerp.addons.portal.controllers.portal import _build_url_w_params
...
def get_request_website():
    ...
    ```
    from betopiaerp.addons.website.models import ir_http
...
class IrHttp(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(betopiaerp.tools.config['server_wide_modules'])
