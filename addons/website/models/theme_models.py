...
import logging
from betopiaerp import api, fields, models, modules
from betopiaerp.tools.translate import xml_translate
from betopiaerp.modules.module import get_resource_from_path

from betopiaerp.addons.base.models.ir_asset import AFTER_DIRECTIVE, APPEND_DIRECTIVE, BEFORE_DIRECTIVE, DEFAULT_SEQUENCE, INCLUDE_DIRECTIVE, PREPEND_DIRECTIVE, REMOVE_DIRECTIVE, REPLACE_DIRECTIVE
