...
from betopiaerp import api, fields, models, tools, release
from betopiaerp.addons.website.models.ir_http import sitemap_qs2dom
from betopiaerp.addons.website.tools import similarity_score, text_from_html, get_base_domain
from betopiaerp.addons.portal.controllers.portal import pager
...
from betopiaerp.modules.module import get_manifest
from betopiaerp.tools import SQL, Query
from betopiaerp.tools.image import image_process
from betopiaerp.tools.sql import escape_psql
...
DEFAULT_WEBSITE_ENDPOINT = 'https://website.api.betopiaerp.com'
DEFAULT_OLG_ENDPOINT = 'https://olg.api.betopiaerp.com'
...
class Website(models.Model):
    ...
    def get_website_page_ids(self):
        ...
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the BetopiaERP framework works.
