...
from betopiaerp.addons.website.controllers.main import Website
...
from betopiaerp.tools import config, mute_logger
...
class WithContext(HttpCase):
    ...
    @mute_logger('betopiaerp.addons.rpc.controllers.xmlrpc')
