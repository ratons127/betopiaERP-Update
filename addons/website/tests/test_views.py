...
from betopiaerp.exceptions import MissingError
from betopiaerp.modules.module import _DEFAULT_MANIFEST, Manifest
from betopiaerp.tests import common, HttpCase, tagged
...
class TestCowViewSaving(TestViewSavingCommon, HttpCase):
    ...
    def test_view_to_translate_tag(self):
        ...
        with patch('betopiaerp.addons.website.models.ir_http.get_request_website', lambda: website):
...
class TestThemeViews(common.TransactionCase):
    def test_inherit_specific(self):
        ...
        patcher = patch('betopiaerp.modules.Manifest.for_addon', return_value=Manifest(path='/dummy/test_theme', manifest_content=_DEFAULT_MANIFEST))
        ...
        new_arch = '<xpath expr="//body" position="replace"><span>BetopiaERP Change01</span></xpath>'
        ...
        new_arch = '<xpath expr="//body" position="replace"><span>BetopiaERP Change02</span></xpath>'
        theme_view.arch = new_arch
        test_theme_module.with_context(load_all_views=True)._theme_load(website_1)
        ...
        new_arch = '<xpath expr="//body" position="replace"><span>BetopiaERP</span></xpath>'
