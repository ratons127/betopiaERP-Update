...
from betopiaerp.addons.html_editor.controllers.main import HTML_Editor
from betopiaerp.addons.website.tests.common import HttpCaseWithWebsiteUser
from betopiaerp.fields import Command


@betopiaerp.tests.tagged('-at_install', 'post_install')
class TestUiCustomizeTheme(betopiaerp.tests.HttpCase):
...
@betopiaerp.tests.tagged('external', '-standard', '-at_install', 'post_install')
...
@betopiaerp.tests.tagged('-at_install', 'post_install')
class TestUiTranslate(betopiaerp.tests.HttpCase):
