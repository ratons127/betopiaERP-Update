...
from betopiaerp.addons.website.models.website_visitor import WebsiteVisitor
from betopiaerp.tests import common, tagged, HttpCase
...
class WebsiteVisitorTests(WebsiteVisitorTestsCommon):
    ...
    def test_merge_partner_with_visitor_single(self):
        """ The partner merge feature of BetopiaERP is auto discovering relations to
