...
from betopiaerp import http, SUPERUSER_ID
from betopiaerp.addons.base.models.ir_qweb_fields import nl2br, nl2br_enclose
from betopiaerp.http import request
from betopiaerp.tools import plaintext2html
from betopiaerp.exceptions import AccessDenied, ValidationError, UserError
from betopiaerp.tools.misc import hmac, consteq
