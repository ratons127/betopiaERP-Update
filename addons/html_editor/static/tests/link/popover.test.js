...
describe("link preview", () => {
    ...
    test("test external link preview", async () => {
        onRpc("/html_editor/link_preview_external", () => ({
            og_description:
                "From ERP to CRM, eCommerce and CMS. Download BetopiaERP or use it in the cloud. Grow Your Business.",
            og_image: "https://www.BetopiaERP.com/web/image/41207129-1abe7a15/homepage-seo.png",
        ...
        expect(".o_we_url_link").toHaveText("Open Source ERP and CRM | BetopiaERP");
    ...
    test("test external metadata cached correctly", async () => {
        const title = "Open Source ERP and CRM | BetopiaERP";
        const description =
            "From ERP to CRM, eCommerce and CMS. Download BetopiaERP or use it in the cloud. Grow Your Business.";
        onRpc("/html_editor/link_preview_external", () => {
