...
import { pasteHtml, pasteBetopiaERPEditorHtml, pasteText, undo } from "./_helpers/user_actions";
...
describe("Unwrapping html element", () => {
    ...
    test("should unwrap li elements having no ul/ol (1)", async () => {
        await testEditor({
            contentBefore: "<p>[]<br></p>",
            stepFunction: async (editor) => {
                pasteBetopiaERPEditorHtml(editor, "<li><p>abc</p></li><li><p>def</p></li>");
            },
            contentAfter: "<p>abc</p><p>def[]</p>",
        });
    });
    ...
    test("should unwrap li elements having no ul/ol (2)", async () => {
        await testEditor({
            contentBefore: "<p>[]<br></p>",
            stepFunction: async (editor) => {
                pasteBetopiaERPEditorHtml(editor, "<li><h1>abc</h1></li><li><h1>def</h1></li");
            },
    ...
    describe("range collapsed", () => {
        ...
        test("should paste and transform plain text content over an empty link (collapsed) (1)", async () => {
            await testEditor({
                ...
                stepFunction: async (editor) => {
                    pasteText(editor, "abc www.BetopiaERP.com xyz");
                },
                contentAfter: '<p>abc <a href="http://www.BetopiaERP.com">www.BetopiaERP.com</a> xyz[]</p>',
            });
        });
    ...
    describe("range not collapsed", () => {
        ...
        test("should restore selection when pasting plain text followed by UNDO (2) (not collapsed)", async () => {
            await testEditor({
                contentBefore: "<p>[abc]</p>",
                stepFunction: async (editor) => {
                    pasteText(editor, "www.BetopiaERP.com");
                    undo(editor);
                },
                contentAfter: "<p>[abc]</p>",
            });
        ...
        test("should restore selection when pasting plain text followed by UNDO (3) (not collapsed)", async () => {
            await testEditor({
                contentBefore: "<p>[abc]</p>",
                stepFunction: async (editor) => {
                    pasteText(editor, "def www.BetopiaERP.com xyz");
                    undo(editor);
                },
                contentAfter: "<p>[abc]</p>",
            });
        ...
        test("should paste and transform plain text content over a link if all of its contents is selected (not collapsed) (1)", async () => {
            await testEditor({
                ...
                contentAfter: '<p><a href="http://www.BetopiaERP.com">www.BetopiaERP.com</a>[]</p>',
            });
        });
...
describe("BetopiaERP editor own html", () => {
    test("should paste html as is", async () => {
        await testEditor({
            contentBefore: "<p>a[]b</p>",
            stepFunction: async (editor) => {
                pasteBetopiaERPEditorHtml(editor, '<div class="custom-paste oe_unbreakable">b</div>');
            },
    ...
    test("should not paste unsafe content", async () => {
        await testEditor({
            contentBefore: "<p>a[]b</p>",
            stepFunction: async (editor) => {
                pasteBetopiaERPEditorHtml(editor, `<script>console.log('xss attack')</script>`);
            },
...
describe("paste in contenteditable span", () => {
    test("should unwrap block when pasting inside a contenteditable span", async () => {
        ...
        pasteBetopiaERPEditorHtml(editor, `<h1>text<b>bold text</b>more text</h1>`);
        expect(getContent(el)).toBe(
    ...
    <head>
        ...
        <style>
            ...
            .font12 {
                ...
                font-style: italic;
                text-decoration: none;
                font-family: "BetopiaERP Unicode Support Noto";
    ...
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="0" dir="ltr" border="1"
        ...
        <tbody>
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;font-family:BetopiaERP Unicode Support Noto;font-weight:normal;font-style:italic;color:#495057;"
            ...
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;font-family:BetopiaERP Unicode Support Noto;font-weight:bold;color:#495057;"
            ...
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;background-color:#ffff00;font-family:BetopiaERP Unicode Support Noto;font-weight:normal;color:#495057;"
