...
/**
 * @typedef { Object } CollaborationBetopiaERPShared
 * @property { CollaborationBetopiaERPPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationBetopiaERPPlugin extends Plugin {
    static id = "collaborationBetopiaERP";
        ...
        return new PeerToPeer({
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    case "ptp_remove":
                        // todo: to implement
                        // this.betopiaerpEditor.multiselectionRemove(notificationPayload);
                        break;
                    case "ptp_disconnect":
                        this.ptp.removePeer(fromPeerId);
                        // todo: to implement
                        // this.betopiaerpEditor.multiselectionRemove(fromPeerId);
                        break;
    ...
    async resetFromServerAndResyncWithPeers() {
        ...
        // lastHistoryId will be different if the betopiaerp bus did not have time to
        // notify the user.
    ...
    showConflictDialog() {
        ...
        //     return;
        // }
        // const content = markup(this.betopiaerpEditor.editable.cloneNode(true).outerHTML);
