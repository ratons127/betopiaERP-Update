...
from betopiaerp import _, http, tools, SUPERUSER_ID
from betopiaerp.addons.html_editor.tools import get_video_url_data
from betopiaerp.exceptions import UserError, MissingError, AccessError
from betopiaerp.http import request
from betopiaerp.tools.image import image_process, image_data_uri, binary_to_image, get_webp_size
...
from betopiaerp.addons.mail.tools import link_preview
from lxml import html, etree

from ..models.ir_attachment import SUPPORTED_IMAGE_MIMETYPES

DEFAULT_LIBRARY_ENDPOINT = 'https://media-api.betopiaerp.com'
