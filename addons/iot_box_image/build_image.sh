...
# Download and extract Raspberry Pi OS, ngrok and clone BetopiaERP repository
...
mkdir -pv ./.ssh
echo "y" | ssh-keygen -t ed25519 -f "./.ssh/iotbox_ca_${VERSION_IOTBOX}" -N "" -C "BetopiaERP SSH CA ${VERSION_IOTBOX}"
