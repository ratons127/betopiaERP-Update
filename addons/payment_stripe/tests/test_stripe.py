...
from betopiaerp.addons.payment_stripe.tests.common import StripeCommon
...
class StripeTest(StripeCommon, PaymentHttpCommon):
    ...
    @mute_logger('betopiaerp.addons.payment_stripe.models.payment_transaction')
    ...
    @mute_logger('betopiaerp.addons.payment_stripe.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        """ Test the processing of a webhook notification. """
        tx = self._create_transaction('redirect')
        url = self._build_url(StripeController._webhook_url)
        with patch(
            'betopiaerp.addons.payment_stripe.controllers.main.StripeController._verify_signature'
        ):
    ...
    def test_validate_amount_succeeds_for_special_currencies(self):
        for currency_code in const.CURRENCY_DECIMALS:
            ...
            with patch(
                'betopiaerp.addons.payment_stripe.models.payment_transaction.PaymentTransaction'
    ...
    def test_webhook_notification_tokenizes_payment_method(self):
        ...
        with patch(
            ...
            'betopiaerp.addons.payment.models.payment_transaction.PaymentTransaction._tokenize'
