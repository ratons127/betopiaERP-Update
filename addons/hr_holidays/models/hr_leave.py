...
from betopiaerp.addons.resource.models.utils import HOURS_PER_DAY

from betopiaerp import api, fields, models
from betopiaerp.addons.base.models.res_partner import _tz_get
from betopiaerp.exceptions import AccessError, UserError, ValidationError
from betopiaerp.tools.date_utils import float_to_time
from betopiaerp.fields import Command, Date, Domain
from betopiaerp.tools.float_utils import float_round, float_compare
from betopiaerp.tools.intervals import Intervals
from betopiaerp.tools.misc import clean_context, format_date
        ...
        for holiday in holidays:
            if not self.env.context.get('leave_fast_create'):
                ...
                if holiday.validation_type == 'no_validation':
                    ...
                    holiday_sudo.message_post(body=_("The time off has been automatically approved"), subtype_xmlid="mail.mt_comment") # Message from BetopiaERPBot (sudo)
