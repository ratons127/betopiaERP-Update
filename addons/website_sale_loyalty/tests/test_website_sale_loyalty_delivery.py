...
from betopiaerp.addons.base.tests.common import DISABLED_MAIL_CONTEXT
...
from betopiaerp.addons.website_sale_loyalty.controllers.cart import Cart
from betopiaerp.addons.website_sale_loyalty.controllers.delivery import WebsiteSaleLoyaltyDelivery
