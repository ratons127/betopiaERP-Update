...
from betopiaerp.addons.point_of_sale.tests.test_generic_localization import TestGenericLocalization
...
from betopiaerp.addons.account_edi.tests.common import AccountEdiTestCommon
