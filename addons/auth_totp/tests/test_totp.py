...
from betopiaerp.tests import tagged, get_db_name, new_test_user, HttpCase
from betopiaerp.tools import mute_logger

from betopiaerp.addons.auth_totp.models.totp import TOTP as auth_TOTP
...
class TestTOTPMixin:
    ...
    def setUpClass(cls):
        ...
        ml = mute_logger('betopiaerp.addons.rpc.controllers.xmlrpc')
...
class TestTOTP(TestTOTPMixin, HttpCase):
    ...
    def test_totp(self):
        # 1. Enable 2FA
        self.start_tour('/betopiaerp', 'totp_tour_setup', login='test_user')
        ...
        with self.assertRaisesRegex(Fault, r'Access Denied'), mute_logger("betopiaerp.http"):
        ...
        with self.assertLogs("betopiaerp.addons.auth_totp.models.res_users", "WARNING") as cm:
    ...
    def test_totp_administration(self):
        ...
        self.start_tour('/betopiaerp', 'totp_admin_disables', login='admin')
        self.start_tour('/', 'totp_login_disabled', login=None)
