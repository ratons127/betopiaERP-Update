...
from betopiaerp import _, http, release
from betopiaerp.exceptions import ValidationError
from betopiaerp.http import request
from betopiaerp.tools import py_to_js_locale, urls
...
class AdyenController(http.Controller):
    ...
    def adyen_return_from_3ds_auth(self, **data):
        ...
        The route is flagged with `save_session=False` to prevent BetopiaERP from assigning a new session
        ...
        # of BetopiaERP in some cases. For instance, when a 3DS1 authentication is required, or for
