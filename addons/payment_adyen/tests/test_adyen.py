...
from betopiaerp.addons.payment_adyen import utils as adyen_utils
from betopiaerp.addons.payment_adyen.controllers.main import AdyenController
from betopiaerp.addons.payment_adyen.tests.common import AdyenCommon
...
class AdyenTest(AdyenCommon, PaymentHttpCommon):
    ...
    def test_processing_values(self):
        ...
        with mute_logger('betopiaerp.addons.payment.models.payment_transaction'), \
            patch(
                'betopiaerp.addons.payment.utils.generate_access_token',
        ...
        with patch(
            'betopiaerp.addons.payment.utils.generate_access_token', new=self._generate_test_access_token
        ):
    ...
    @mute_logger('betopiaerp.addons.payment_adyen.models.payment_transaction')
    ...
    def test_application_info_passed_in_payment_request(self):
        ...
        tx = self._create_transaction('direct')
        with (
            patch('betopiaerp.addons.payment.utils.check_access_token', return_value='dummy_token'),
            patch(
                'betopiaerp.addons.payment.models.payment_provider.PaymentProvider._send_api_request',
                return_value=dict(),
    ...
    @mute_logger('betopiaerp.addons.payment_adyen.controllers.main')
    @mute_logger('betopiaerp.addons.payment_adyen.models.payment_transaction')
    def _webhook_notification_flow(self, payload):
        ...
        with patch('betopiaerp.addons.payment_adyen.controllers.main.AdyenController._verify_signature'):
    ...
    def test_webhook_notification_triggers_signature_check(self):
        ...
        url = self._build_url(AdyenController._webhook_url)
        with patch(
            'betopiaerp.addons.payment_adyen.controllers.main.AdyenController._verify_signature'
