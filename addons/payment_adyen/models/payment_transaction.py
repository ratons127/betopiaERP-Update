...
from betopiaerp import _, api, models, release
from betopiaerp.tools import format_amount
...
from betopiaerp.addons.payment_adyen import const
            ...
            if source_tx:
                ...
                if source_tx.amount == converted_notification_amount:  # Full capture/void.
                    ...
                    if tx and tx.amount != converted_notification_amount:
                        ...
                        # others captures that BetopiaERP was unaware of were done, the amount voided will
