...
from betopiaerp.tools import _, LazyTranslate
from betopiaerp.exceptions import ValidationError
from betopiaerp.addons.base.models.res_partner import EU_EXTRA_VAT_CODES
    ...
    def _compute_vies_valid(self):
        ...
        for partner in self:
            ...
            if partner.parent_id and partner.parent_id.vat == partner.vat:
                ...
                continue
            from betopiaerp.tools import zeep  # noqa: PLC0415
            try:
