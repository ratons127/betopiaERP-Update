...
from betopiaerp.modules.loading import force_demo
from betopiaerp.tools import make_index_name, SQL
from betopiaerp.tools.translate import TranslationImporter
from betopiaerp.tests import standalone
from betopiaerp.addons.account.models.chart_template import AccountChartTemplate
...
def test_all_l10n(env):
    ...
    logger = logging.getLogger('betopiaerp.loading')
