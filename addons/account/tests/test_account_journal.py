...
from betopiaerp.tools import hash_sign
...
from betopiaerp.tests import Form, tagged, HttpCase, new_test_user
from betopiaerp.addons.test_mail.data.test_mail_data import MAIL_EML_ATTACHMENT
