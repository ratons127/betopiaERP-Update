...
from betopiaerp.addons.account.tests.test_account_journal_dashboard_common import TestAccountJournalDashboardCommon
from betopiaerp.tests import tagged
from betopiaerp.tools.misc import format_amount
