...
from betopiaerp import api, Command, fields, models, _
...
from betopiaerp.tools import email_normalize, email_normalize_all, groupby, urls
from betopiaerp.tools.misc import hash_sign
...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(
        ...
        help="You can choose different models for each type of reference. The default one is the BetopiaERP reference.",
    )
    ...
    alias_name = fields.Char(help="Send one separate email for each invoice.\n"
                                  ...
                                  "Only PDF and XML files will be interpreted by BetopiaERP")
