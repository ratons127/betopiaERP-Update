...
from betopiaerp.addons.account.tests.common import PatchRequestsMixin
from betopiaerp.addons.account.tests.test_account_move_send import TestAccountMoveSendCommon
from betopiaerp.addons.l10n_hr_edi.tests.test_hr_edi_common import TestL10nHrEdiCommon
...
class TestHrEdiFlowsMocked(TestL10nHrEdiCommon, TestAccountMoveSendCommon, PatchRequestsMixin):
    ...
    def setUpClass(cls):
        ...
        company.write({
            ...
            'l10n_hr_mer_software_ident': 'SaBetopiaERP-001',
            ...
            (
                ...
                self._build_response(
                    ...
                    response_json={
                        ...
                        'RecipientBusinessName': 'BetopiaERP S.A.',
            ...
            (
                ...
                self._build_response(
                    ...
                    response_json=[{
                        ...
                        'SenderBusinessName': 'BetopiaERP S.A.',
