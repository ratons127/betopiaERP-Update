...
import betopiaerp
from betopiaerp import api, modules
from .models.bus import dispatch
from .tools import orjson
from betopiaerp.http import root, Request, Response, SessionExpiredException, get_default_session
from betopiaerp.modules.registry import Registry
from betopiaerp.service import model as service_model
from betopiaerp.service.server import CommonServer
from betopiaerp.service.security import check_session
...
class Websocket:
    ...
    def __init__(self, sock, session, cookies):
        ...
        self.__selector = (
            ...
            if betopiaerp.evented and hasattr(selectors, 'PollSelector')
...
class WebsocketConnectionHandler:
    ...
    def _handle_public_configuration(cls, request):
        if not os.getenv('BETOPIAERP_BUS_PUBLIC_SAMESITE_WS'):
            return
