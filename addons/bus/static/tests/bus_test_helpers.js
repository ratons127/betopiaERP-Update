...
/** @type {Record<string, (env: BetopiaERPEnv, id: string, payload: any) => any>} */
const busMessageHandlers = {};
/** @type {Map<BetopiaERPEnv, { id: number, type: string, payload: NotificationPayload }[]>} */
 ...
 *
 * @param {string} type
 * @param {(env: BetopiaERPEnv, id: string, payload: any) => any} handler
 */
