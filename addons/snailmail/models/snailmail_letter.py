...
from betopiaerp.tools.pdf import PdfFileReader, PdfFileWriter
from betopiaerp.tools.safe_eval import safe_eval

DEFAULT_ENDPOINT = 'https://iap-snailmail.betopiaerp.com'
...
class SnailmailLetter(models.Model):
    ...
    def _get_error_message(self, error):
        ...
        if error == 'TRIAL_ERROR':
            link = self.env['iap.account'].get_credits_url(service_name='snailmail')
            return _('You don\'t have an IAP account registered for this service.<br>Please go to <a href=%s target="new">iap.betopiaerp.com</a> to claim your free credits.', link)
