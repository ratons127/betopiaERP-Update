...
from betopiaerp import api, fields, models, _, Command, tools, SUPERUSER_ID
from betopiaerp.http import request
from betopiaerp.exceptions import AccessError, ValidationError, UserError
from betopiaerp.tools import SQL, convert
from betopiaerp.service.common import exp_version
from betopiaerp.addons.point_of_sale.models.pos_printer import format_epson_certified_domain
