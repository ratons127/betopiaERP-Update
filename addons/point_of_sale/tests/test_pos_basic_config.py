...
class TestPoSBasicConfig(TestPoSCommon):
    ...
    def test_cash_register_if_no_order(self):
        ...
        with (
            self.assertLogs('betopiaerp.addons.point_of_sale.models.pos_order', level='DEBUG') as cm,
            unittest.mock.patch('betopiaerp.addons.point_of_sale.models.pos_order.randrange', return_value=1996)
        ):
