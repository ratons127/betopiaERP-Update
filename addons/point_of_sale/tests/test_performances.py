...
from betopiaerp.cli.populate import Populate
...
class TestPosPerformance(TestPointOfSaleHttpCommon):
    ...
    @mute_logger('betopiaerp.models.unlink', 'betopiaerp.cli.populate', 'betopiaerp.tools.populate', 'betopiaerp.tests.common', 'werkzeug')
