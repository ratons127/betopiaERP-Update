...
from betopiaerp.addons.stock.tests.test_generate_serial_numbers import StockGenerateCommon
from betopiaerp.addons.stock.tests.test_picking_tours import TestStockPickingTour
