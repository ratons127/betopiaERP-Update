...
from betopiaerp.addons.link_tracker.tests.common import MockLinkTracker
...
class TestLinkTracker(common.TransactionCase, MockLinkTracker):
    ...
    def setUp(self):
        ...
        self._web_base_url = 'https://test.betopiaerp.com'
    ...
    def test_create(self):
        ...
        self.assertEqual(
            ...
            ['http://betopiaerp.com', 'http://example.com', 'http://test.example.com'],
        )
    ...
    def test_search_or_create(self):
        values_1, values_2, values_3 = [
            {'url': 'https://betopiaerp.com', 'title': 'BetopiaERP'},
            {'url': 'https://betopiaerp.be', 'title': 'BetopiaERP'},
            {'url': 'https://betopiaerp.com', 'title': 'BetopiaERP New', 'label': 'New one!'}  # title is not in unique constraint
        ]
        expected_values_1, expected_values_2, expected_values_3 = [
            {
                ...
                'source_id': self.env['utm.source'],
                'title': 'BetopiaERP',
                'url': 'https://betopiaerp.be',
            }, {
                'campaign_id': self.env['utm.campaign'],
                'label': 'New one!',
                'medium_id': self.env['utm.medium'],
                'source_id': self.env['utm.source'],
                'title': 'BetopiaERP New',
                'url': 'https://betopiaerp.com',
            },
        ]
        ...
        values_4 = {'url': 'https://betopiaerp.com', 'label': 'A different one'}
        ...
        values_5 = {'url': 'https://betopiaerp.com', 'label': 'Yet another label'}
        expected_values_5 = {
            'campaign_id': self.env['utm.campaign'],
