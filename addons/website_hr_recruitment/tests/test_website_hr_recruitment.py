...
from betopiaerp.addons.website_hr_recruitment.controllers.main import WebsiteHrRecruitment

@betopiaerp.tests.tagged('post_install', '-at_install')
class TestWebsiteHrRecruitmentForm(betopiaerp.tests.HttpCase):
    def test_tour(self):
        ...
        with betopiaerp.tests.RecordCapturer(self.env['hr.applicant']) as capt:
