...
from betopiaerp import models, api, _
...
class ResCurrencyRate(models.Model):
    ...
    def _onchange_rate_warning(self):
        # We send the ETA a rate that is 5 decimal accuracy, so to ensure consistency, BetopiaERP should also operate with 5 decimal accuracy rate
        if (
