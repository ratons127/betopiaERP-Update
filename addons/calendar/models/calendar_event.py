...
from betopiaerp.addons.calendar.models.calendar_attendee import CalendarAttendee
from betopiaerp.addons.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from betopiaerp.addons.calendar.models.utils import interval_from_events
from betopiaerp.tools.intervals import intervals_overlap
from betopiaerp.tools.translate import _
from betopiaerp.tools.misc import get_lang
from betopiaerp.tools import html2plaintext, html_sanitize, is_html_empty, single_email_re
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'BetopiaERP'
