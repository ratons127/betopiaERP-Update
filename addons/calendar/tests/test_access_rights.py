...
class TestAccessRights(TransactionCase):
    ...
    @classmethod
    @mute_logger('betopiaerp.tests', 'betopiaerp.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_meeting_edit_access_notification_handle_in_betopiaerp(self):
        # set notifications to "handle in BetopiaERP" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in BetopiaERP" notification setting can
