...
from betopiaerp.addons.event.tests.common import EventCase
from betopiaerp.addons.event.models.event_mail import EventMail
from betopiaerp.addons.mail.tests.common import MailCase
from betopiaerp.tests import tagged, users, warmup
...
class TestMailSchedule(EventMailCommon):
    ...
    @mute_logger('betopiaerp.addons.event.models.event_mail')
    @users('user_eventmanager')
    ...
    @mute_logger('betopiaerp.addons.event.models.event_mail', 'betopiaerp.addons.mail.models.mail_render_mixin')
    @users('user_eventmanager')
    ...
    @mute_logger(
        'betopiaerp.addons.event.models.event_mail',
        'betopiaerp.addons.event.models.event_mail_registration',
        'betopiaerp.addons.event.models.event_registration',
    )
