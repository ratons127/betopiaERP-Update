...
from betopiaerp.addons.payment_razorpay.tests.common import RazorpayCommon


@tagged('post_install', '-at_install')
class TestProcessingFlows(RazorpayCommon, PaymentHttpCommon):

    @mute_logger('betopiaerp.addons.payment_razorpay.controllers.main')
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'betopiaerp.addons.payment_razorpay.controllers.main.RazorpayController._verify_signature'
        ), patch(
    ...
    def test_accept_webhook_notification_with_valid_signature(self):
        ...
        with patch(
            'betopiaerp.addons.payment_razorpay.models.payment_provider.PaymentProvider'
