...
from betopiaerp.addons.payment_razorpay.const import HANDLED_WEBHOOK_EVENTS
...
class RazorpayController(http.Controller):
    ...
    def razorpay_return_from_checkout(self, reference, **data):
        ...
        The route is configured with save_session=False to prevent BetopiaERP from creating a new session
