...
from betopiaerp.addons.payment_razorpay import const
from betopiaerp.addons.payment_razorpay.controllers.main import RazorpayController
    ...
    def _apply_updates(self, payment_data):
        ...
        if entity_status in const.PAYMENT_STATUS_MAPPING['pending']:
            ...
            if (
                ...
                # In case the tokenization was requested on provider side not from betopiaerp form.
                self.tokenize = True
            self._set_done()
