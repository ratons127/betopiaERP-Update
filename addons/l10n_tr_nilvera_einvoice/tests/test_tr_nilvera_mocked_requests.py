...
from betopiaerp.tests import freeze_time, tagged
from betopiaerp.tools import file_open

from betopiaerp.addons.l10n_tr_nilvera_einvoice.tests.test_xml_ubl_tr_common import TestUBLTRCommon
...
def patch_nilvera_request(function):
    ...
    def wrapper(*args, **kwargs):
        with patch(
            'betopiaerp.addons.l10n_tr_nilvera.lib.nilvera_client.NilveraClient.request',
...
class TestTRNilveraMockedRequests(TestUBLTRCommon):
    ...
    def test_which_service_to_call(self):
        ...
        with patch('betopiaerp.addons.l10n_tr_nilvera_einvoice.models.account_move.AccountMove._l10n_tr_nilvera_submit_einvoice') as mock_submit_einvoice, \
             patch('betopiaerp.addons.l10n_tr_nilvera_einvoice.models.account_move.AccountMove._l10n_tr_nilvera_submit_earchive') as mock_submit_earchive:
