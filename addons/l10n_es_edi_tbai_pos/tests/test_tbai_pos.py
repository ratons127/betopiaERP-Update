...
from betopiaerp.addons.l10n_es_edi_tbai.tests.common import TestEsEdiTbaiCommonGipuzkoa
from betopiaerp.addons.l10n_es_edi_tbai_pos.tests.common import CommonPosEsEdiTest
...
class TestPosEdi(TestEsEdiTbaiCommonGipuzkoa, CommonPosEsEdiTest):
    ...
    def pay_pos_order(self, pos_order, with_error=False):
        ...
        with patch(
            'betopiaerp.addons.l10n_es_edi_tbai.models.l10n_es_edi_tbai_document.requests.Session.request',
