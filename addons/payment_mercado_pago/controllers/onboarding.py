...
from betopiaerp import _, fields
from betopiaerp.exceptions import ValidationError
from betopiaerp.http import Controller, request, route
...
class MercadoPagoOnboardingController(Controller):
    ...
    def mercado_pago_return_from_authorization(self, **data):
        ...
        # Retrieve the Mercado Pago data and BetopiaERP metadata from the redirect data.
