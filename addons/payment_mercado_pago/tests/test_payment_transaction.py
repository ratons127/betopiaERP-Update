...
class TestPaymentTransaction(MercadoPagoCommon, PaymentHttpCommon):
    ...
    def test_no_input_missing_from_redirect_form(self):
        ...
        tx = self._create_transaction(flow='redirect')
        with patch(
            'betopiaerp.addons.payment_mercado_pago.models.payment_transaction.PaymentTransaction'
    ...
    @mute_logger('betopiaerp.addons.payment_mercado_pago.models.payment_transaction')
