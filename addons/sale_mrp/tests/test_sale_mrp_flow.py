...
from betopiaerp.tests import Form, common
from betopiaerp.tools import float_compare, mute_logger

from betopiaerp.addons.sale.tests.common import TestSaleCommon
from betopiaerp.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import (
...
class TestSaleMrpFlow(TestSaleMrpFlowCommon):
    ...
    @mute_logger('betopiaerp.tests.common.onchange')
