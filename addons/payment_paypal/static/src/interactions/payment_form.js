...
patch(PaymentForm.prototype, {
    ...
    /**
     * Load the JS from the PayPal SDK URL and set an identifier dedicated to BetopiaERP, for PayPal to be
     * able to recognize which transactions are originating from BetopiaERP.
     *
     * @private
    ...
    async _paypalLoadSDK(paypalSDKURL) {
        ...
        [...paypalSDKs].forEach(sdk => {
            sdk.setAttribute('data-partner-attribution-id', 'BetopiaERPInc_SP_EC');
        });
    },
