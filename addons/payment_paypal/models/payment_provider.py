...
from betopiaerp.addons.payment_paypal import const
from betopiaerp.addons.payment_paypal.controllers.main import PaypalController
...
class PaymentProvider(models.Model):
    ...
    def _build_request_headers(
        ...
        headers = {
            ...
            # PayPal requires a reference specific to BetopiaERP to be able to track BetopiaERP customers.
            'PayPal-Partner-Attribution-Id': 'BetopiaERPInc_SP_EC',
        }
        if idempotency_key:
