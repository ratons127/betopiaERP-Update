...
from betopiaerp.addons.payment_paypal import utils as paypal_utils
from betopiaerp.addons.payment_paypal.const import PAYMENT_STATUS_MAPPING
...
class PaymentTransaction(models.Model):
    ...
    # this field has no use in BetopiaERP except for debugging
