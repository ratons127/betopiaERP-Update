...
from betopiaerp.addons.payment_paypal.tests.common import PaypalCommon
...
class PaypalTest(PaypalCommon, PaymentHttpCommon):
    ...
    @mute_logger('betopiaerp.addons.payment_paypal.controllers.main')
    ...
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'betopiaerp.addons.payment_paypal.controllers.main.PaypalController'
