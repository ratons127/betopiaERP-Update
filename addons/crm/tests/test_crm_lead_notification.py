...
from betopiaerp.addons.crm.tests.common import INCOMING_EMAIL, TestCrmCommon
from betopiaerp.tests import tagged, users
from betopiaerp.tools import email_normalize, formataddr, mute_logger
        ...
        leads = self.env['crm.lead'].create([
            {
                ...
                'partner_id': partner_no_email.id,
                'email_cc': 'test_cc@betopiaerp.com',
                'user_id': self.user_sales_leads.id
            }
        ])
