...
from betopiaerp.addons.crm.tests.common import TestCrmCommon
from betopiaerp.addons.iap.tools import iap_tools
from betopiaerp.tests.common import tagged, users
...
class TestCRMLead(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.emails_provider_generic = {
            ...
            ('fp@betopiaerp.com', 'fp@betopiaerp.com'),
            ('fp.alias@mail.betopiaerp.com', 'fp.alias@mail.betopiaerp.com'),
        }
        cls.emails_provider_company = {
            ('robert.poilvert@mycompany.com', 'mycompany.com'),
            ('fp@subdomain.betopiaerp.com', 'subdomain.betopiaerp.com'),
        }
        ...
        cls.lead_generic_email_dupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': '"Fabulous Fab" <fp@BETOPIAERP.COM>',
                'name': 'Dupe1 of fp@betopiaerp.com (same email)',
                'type': 'lead',
            },
            {
                'email_from': 'FP@betopiaerp.com',
                'name': 'Dupe2 of fp@betopiaerp.com (same email)',
                'type': 'lead',
            },
            # phone_sanitized based
            {
                'email_from': 'not.fp@not.betopiaerp.com',
                'name': 'Dupe3 of fp@betopiaerp.com (same phone sanitized)',
                'phone': '+1 202 555 0123',
                'type': 'lead',
            },
            {
                'email_from': 'not.fp@not.betopiaerp.com',
                'phone': '+1 202 555 0123',
                'name': 'Dupe4 of fp@betopiaerp.com (same phone sanitized)',
                'type': 'lead',
            },
            # same commercial entity
            {
                'name': 'Dupe5 of fp@betopiaerp.com (same commercial entity)',
                'partner_id': cls.test_partners[1].id,
            },
            {
                'name': 'Dupe6 of fp@betopiaerp.com (same commercial entity)',
        ...
        cls.lead_generic_email_notdupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': 'not.fp@betopiaerp.com',
                'name': 'NotADupe1',
                'type': 'lead',
            },
        ])
    ...
    def test_assert_initial_values(self):
        ...
        self.assertEqual(lead_generic.email_domain_criterion, 'fp@betopiaerp.com')
        self.assertEqual(lead_generic.email_normalized, 'fp@betopiaerp.com')
