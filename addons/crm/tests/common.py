...
from betopiaerp.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from betopiaerp.addons.mail.tests.common import MailCase, mail_new_test_user
...
from betopiaerp.fields import Datetime
from betopiaerp import models, tools
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('betopiaerp.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
