...
from betopiaerp.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('betopiaerp.models.unlink', 'betopiaerp.addons.crm.models.crm_team', 'betopiaerp.addons.crm.models.crm_team_member')
