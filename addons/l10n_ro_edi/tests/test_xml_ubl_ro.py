...
from betopiaerp.addons.l10n_account_edi_ubl_cii_tests.tests.common import (
    TestUBLCommon,
)
from betopiaerp.addons.l10n_ro_edi.models.account_move import HOLDING_DAYS
...
class TestUBLRO(TestUBLCommon):
    ...
    @patch('betopiaerp.addons.l10n_ro_edi.models.account_move._request_ciusro_synchronize_invoices', new=_patch_request_ciusro_synchronize_invoices)
