...
from betopiaerp.exceptions import AccessDenied, AccessError
from betopiaerp.http import _request_stack
from betopiaerp.service import common as auth
from betopiaerp.service import model
from betopiaerp.tests import common
from betopiaerp.tools import DotDict, mute_logger

from betopiaerp.addons.base.tests.common import SavepointCaseWithUserDemo
...
class TestXMLRPC(common.HttpCase):
    ...
    def setUp(self):
        ...
        ml_xml = mute_logger('betopiaerp.addons.rpc.controllers.xmlrpc')
        ml_xml.__enter__()  # noqa: PLC2801
        self.addCleanup(ml_xml.__exit__)

        ml_json = mute_logger('betopiaerp.addons.rpc.controllers.jsonrpc')
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   betopiaerp.api.model(lambda *_: collections.defaultdict(int)))
