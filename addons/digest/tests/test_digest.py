...
from betopiaerp.addons.digest.tests.common import TestDigestCommon
...
from betopiaerp.tools import mute_logger, urls
...
class TestUnsubscribe(MailCommon, HttpCaseWithUserDemo):
    ...
    def test_unsubscribe_token_one_click(self):
        ...
        with mute_logger('betopiaerp.addons.http_routing.models.ir_http'):
