    ...
    */
    ...
    _call_viva_com(data, action, paymentLine) {
        return this.env.services.orm.silent
            ...
            .catch(this._handleBetopiaERPConnectionFailure.bind(this, paymentLine));
    }

    _handleBetopiaERPConnectionFailure(paymentLine, data = {}) {
        // handle timeout
        ...
        this._show_error(
            _t(
                "Could not connect to the BetopiaERP server, please check your internet connection and try again."
            )
        );
    ...
    handleVivaComStatusResponse(paymentLine, notification) {
        if (!notification) {
            this._handleBetopiaERPConnectionFailure(paymentLine);
            return;
        }
