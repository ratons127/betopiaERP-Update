...
from betopiaerp.tools import float_compare
from betopiaerp.tools.misc import clean_context, OrderedSet
...
class MrpBom(models.Model):
    ...
    allow_operation_dependencies = fields.Boolean('Operation Dependencies',
        help="Create operation level dependencies that will influence both planning and the status of work orders upon MO confirmation. If this feature is ticked, and nothing is specified, BetopiaERP will assume that all operations can be started simultaneously."
    )
