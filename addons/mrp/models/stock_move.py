...
from betopiaerp import _, api, Command, fields, models
from betopiaerp.tools import OrderedSet, float_is_zero
...
class StockMove(models.Model):
    ...
    manual_consumption = fields.Boolean(
        ...
        help="When activated, then the registration of consumption for that component is recorded manually exclusively.\n"
             "If not activated, and any of the components consumption is edited manually on the manufacturing order, BetopiaERP assumes manual consumption also.")
