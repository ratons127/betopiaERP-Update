...
from betopiaerp.addons.iot_drivers.tools import certificate, helpers, upgrade, wifi
from betopiaerp.addons.iot_drivers.tools.system import IS_RPI
from betopiaerp.addons.iot_drivers.websocket_client import WebsocketClient
...
class Manager(Thread):
    ...
    def _send_all_devices(self, server_url=None):
        """This method send IoT Box and devices information to BetopiaERP database
