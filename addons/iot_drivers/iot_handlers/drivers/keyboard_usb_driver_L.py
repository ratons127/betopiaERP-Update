...
from betopiaerp.addons.iot_drivers.driver import Driver
from betopiaerp.addons.iot_drivers.event_manager import event_manager
from betopiaerp.addons.iot_drivers.main import iot_devices
from betopiaerp.addons.iot_drivers.tools import helpers, route
...
class KeyboardUSBDriver(Driver):
    ...
    def _keyboard_input(self, scancode):
        ...
        pressed key represented by its scancode to the connected BetopiaERP instance.
