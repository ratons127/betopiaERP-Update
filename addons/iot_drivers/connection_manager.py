...
from betopiaerp.addons.iot_drivers.main import iot_devices, manager
from betopiaerp.addons.iot_drivers.tools import helpers, upgrade, wifi
from betopiaerp.addons.iot_drivers.tools.system import IS_RPI, IS_TEST
...
class ConnectionManager(Thread):
    ...
    def _register_iot_box(self):
        """ This method is called to register the IoT Box on betopiaerp.com and get a pairing code"""
    ...
    def _get_next_polling_interval(self):
        # To avoid spamming betopiaerp.com with requests we gradually space out the requests
    ...
    def _call_iot_proxy(self):
        ...
        try:
            ...
            _logger.exception('Could not reach iot-proxy.betopiaerp.com')
            return {}
