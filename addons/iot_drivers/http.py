...
from betopiaerp.http import JsonRPCDispatcher, serialize_exception
from betopiaerp.addons.iot_drivers.tools.system import IS_TEST
...
if not IS_TEST:
    # Test IoT system is expected to handle BetopiaERP database unlike "real" IoT systems.

    def db_list(force=False, host=None):
        return []

    betopiaerp.http.db_list = db_list
