    ...
    <t t-translation="off">
        ...
        <BootstrapDialog identifier="'update-configuration'" btnName="'Update'" onOpen.bind="getVersionInfo" onClose.bind="onClose">
            <t t-set-slot="header">
                <div>
                    Update
                    <a href="https://www.BetopiaERP.com/documentation/latest/applications/general/iot/iot_advanced/updating_iot.html" class="fa fa-question-circle text-decoration-none text-dark" target="_blank"></a>
                </div>
            </t>
            <t t-set-slot="body">
                ...
                <div class="mb-3" t-if="this.store.isLinux">
                    ...
                    <div t-else="" class="alert alert-warning small mb-0">
                        ...
                        <a href="https://www.BetopiaERP.com/documentation/latest/applications/general/iot/iot_advanced/updating_iot.html#iot-updating-iot-image-code" target="_blank" class="alert-link">
