...
from betopiaerp.addons.payment_iyzico import const
from betopiaerp.addons.payment_iyzico.tests.common import IyzicoCommon
...
class TestPaymentTransaction(IyzicoCommon, PaymentHttpCommon):
    ...
    def test_no_input_missing_from_redirect_form(self):
        ...
        tx = self._create_transaction('redirect')
        with patch(
            'betopiaerp.addons.payment_iyzico.models.payment_transaction.PaymentTransaction'
