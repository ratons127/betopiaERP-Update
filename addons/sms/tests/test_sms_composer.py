...
from betopiaerp.addons.sms.models.mail_thread import MailThread
from betopiaerp.addons.sms.tests.common import SMSCommon, SMSCase
...
class TestSMSComposerComment(SMSCommon, SMSCase):
    ...
    def test_message_post_sms_vs_notification(self):
        ...
        cases = [
            (
                'Hello there, check this awesome <b>app</b> I found:<br/>https://betopiaerp.com',  # not a `a` link in source
                '<p>Hello there, check this awesome &lt;b&gt;app&lt;/b&gt; I found:&lt;br/&gt;<a href="https://betopiaerp.com" target="_blank" rel="noreferrer noopener">https://betopiaerp.com</a></p>',
                'Hello there, check this awesome <b>app</b> I found:<br/>https://betopiaerp.com'
            ), (
                'Hello there, check this awesome <b>app</b> I found:<br/><a href="https://betopiaerp.com">Here</a>',   # a link
                '<p>Hello there, check this awesome &lt;b&gt;app&lt;/b&gt; I found:&lt;br/&gt;&lt;a href="<a href="https://betopiaerp.com" target="_blank" rel="noreferrer noopener">https://betopiaerp.com</a>"&gt;Here&lt;/a&gt;</p>',
                'Hello there, check this awesome <b>app</b> I found:<br/><a href="https://betopiaerp.com">Here</a>'  # keep all information
            )
        ]
    ...
    def test_message_sms_body_sms_vs_notification(self):
        ...
        cases = [
            (
                "Hello there, check this awesome app I found:\nhttps://betopiaerp.com",
                '<p>Hello there, check this awesome app I found:<br>'
                '<a href="https://betopiaerp.com" target="_blank" rel="noreferrer noopener">https://betopiaerp.com</a></p>',
            ), (
