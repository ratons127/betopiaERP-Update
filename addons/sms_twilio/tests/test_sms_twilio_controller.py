from betopiaerp.addons.sms_twilio.tests.common import MockSmsTwilio
from betopiaerp.addons.sms_twilio.tools import sms_twilio as twilio_tools
...
class TestSmsTwilioController(MockSmsTwilio, HttpCase):
    ...
    @mute_logger('betopiaerp.addons.sms_twilio.controllers.controllers')
    @users('employee')
