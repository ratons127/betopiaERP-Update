...
from betopiaerp.addons.sms.tools.sms_api import SmsApiBase
from betopiaerp.addons.sms_twilio.tools.sms_twilio import get_twilio_from_number, get_twilio_status_callback_url
...
class SmsApiTwilio(SmsApiBase):
    ...
    def _send_sms_batch(self, messages, delivery_reports_url=False):
        ...
        for message in messages:
            ...
            for number_info in message.get('numbers') or []:
                ...
                fields_values = {
                    'failure_reason':  _("Unknown failure at sending, please contact BetopiaERP support"),
                    'state': 'server_error',
                    'uuid': uuid,
                }
    ...
    def _get_sms_api_error_messages(self):
        ...
        error_dict.update({
            ...
            # fallback
            'unknown': _("Unknown error, please contact BetopiaERP support"),
        })
        return error_dict
