...
from betopiaerp import _, release
...
class L10nHuEdiConnection:
    def __init__(self, env):
        ...
        :param env: the BetopiaERP environment
        """
        self.env = env
    ...
    def do_token_exchange(self, credentials):
        ...
        try:
            # Convert into a naive UTC datetime, since BetopiaERP can't store timezone-aware datetimes
