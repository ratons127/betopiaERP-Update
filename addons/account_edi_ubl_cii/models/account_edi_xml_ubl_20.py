...
from betopiaerp import _, models, Command
from betopiaerp.tools import html2plaintext
from betopiaerp.tools.float_utils import float_is_zero, float_round
from betopiaerp.addons.account.tools import dict_to_xml
from betopiaerp.addons.account_edi_ubl_cii.models.account_edi_common import FloatFmt
from betopiaerp.addons.account_edi_ubl_cii.tools import Invoice, CreditNote, DebitNote
    ...
    def _add_invoice_payment_terms_nodes(self, document_node, vals):
        ...
        if payment_term:
            document_node['cac:PaymentTerms'] = {
                # The payment term's note is automatically embedded in a <p> tag in BetopiaERP
