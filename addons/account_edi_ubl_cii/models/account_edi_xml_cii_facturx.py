...
from betopiaerp.tools import float_repr, is_html_empty, html2plaintext, cleanup_xml_node
...
class AccountEdiXmlCii(models.AbstractModel):
    ...
    def _export_invoice_vals(self, invoice):
        ...
        # Fixed taxes are not supposed to be taxes in real live. However, this is the way in BetopiaERP to manage recupel
