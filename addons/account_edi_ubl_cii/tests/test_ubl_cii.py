...
from betopiaerp.tools import file_open, misc
from betopiaerp.tools.safe_eval import datetime

from betopiaerp.addons.account_edi_ubl_cii.tests.common import TestUblCiiCommon
...
class TestAccountEdiUblCii(TestUblCiiCommon, HttpCase):
    ...
    def test_get_invoice_legal_documents_fallback(self):
        ...
        company.email = 'test@test.betopiaerp.com'
