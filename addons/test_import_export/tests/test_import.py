...
from betopiaerp.tests.common import TransactionCase, can_import, RecordCapturer
from betopiaerp.tools import mute_logger, DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('betopiaerp.addons.base_import.models.base_import')
...
foo3,US,0,persons\n""",
    ...
    def test_xls_datetime_values(self):
        ...
        Given how easy this is to land in such a situation using Google Spreadhseet, BetopiaERP should support it.
        """
