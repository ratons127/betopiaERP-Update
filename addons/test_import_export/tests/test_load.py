...
from betopiaerp.tools.misc import file_open, mute_logger
...
class test_integer_field(ImporterCase):
    ...
    @mute_logger('betopiaerp.sql_db', 'betopiaerp.models')
...
class CheckSavepoint(ImporterCase):
    ...
    def test_max_savepoint(self):
        from betopiaerp.sql_db import Cursor  # noqa: PLC0415
        with (
